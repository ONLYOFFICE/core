#ifndef _WMF_CODE_PAGE_1361_H
#define _WMF_CODE_PAGE_1361_H
...
struct TMSCP1361_Pair
{
	unsigned short ushCode;
	unsigned short ushUnicode;
};

static const TMSCP1361_Pair c_aoUnicodeMapCP1361WithLeadByte[] =
{
...
static unsigned short CP1361_Find(unsigned short ushCode)
{
	TMSCP1361_Pair *pPair = (TMSCP1361_Pair *)c_aoUnicodeMapCP950WithLeadByte;
...
static CStringW CP1361_CharToUnicode(const char *sString)
{
	...
	for ( int nIndex = 0; nIndex < nLen; nIndex++ )
	{
		...
		unsigned short ushUnicode = c_anUnicodeMapCP1361[unCode];
		...
		else
		{
			...
			wsString[nIndex] = CP1361_Find( ushCode );
		}
	}
