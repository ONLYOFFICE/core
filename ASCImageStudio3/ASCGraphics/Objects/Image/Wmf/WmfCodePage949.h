#ifndef _WMF_CODE_PAGE_949_H
#define _WMF_CODE_PAGE_949_H

//-- CP949 Encoding -----------------------------------------------------------------------------

#define MSCP949_UNDEFINED 0x0000
#define MSCP949_LEAD_CHAR 0xFFFF // Символ, который означает, что данный код - старший байт
...
struct TMSCP949_Pair
{
	unsigned short ushCode;
	unsigned short ushUnicode;
};

static const TMSCP932_Pair c_aoUnicodeMapCP949WithLeadByte[] =
{	
...
static unsigned short CP949_Find(unsigned short ushCode)
{
	TMSCP949_Pair *pPair = (TMSCP949_Pair *)c_aoUnicodeMapCP949WithLeadByte;
...
static CStringW CP949_CharToUnicode(const char *sString)
{
	...
	for ( int nIndex = 0; nIndex < nLen; nIndex++ )
	{
		...
		unsigned short ushUnicode = c_anUnicodeMapCP949[unCode];

		if ( -1 == nLeadByte )
		{
			if ( MSCP949_LEAD_CHAR != ushUnicode )
			{
		...
		else
		{
			...
			wsString[nIndex] = CP949_Find( ushCode );
		}
	}

	CStringW wsResult( wsString );
	delete []wsString;
