...
//
			WriteStr("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\" ?>\n");
			WriteStr("<wmfxml>\n");
		}
	}
...
//------------------------------------------------------------------------------------------------------------------------
	...
	{	
		...
		case META_SETWINDOWORG: // 2.3.5.31
...

			{
				...
				TWmfCoord oOrigin = { (unsigned int)nParX, (unsigned int)nParY };
	...
	{	
        ...
        unsigned short *test = new unsigned short[ushLength+1];
