 ...
 */
	sal_Int32  rtl_str_getLength( const sal_Char * str );
 ...
 */
	sal_Int32  rtl_str_compare( const sal_Char * first, const sal_Char * second ) ;
...
/** Compare two strings.
    ...
    string is greater than the second string.
 */
	sal_Int32  rtl_str_compare_WithLength( const sal_Char * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen ) ;
 ...
 */
	sal_Int32  rtl_str_shortenedCompare_WithLength( const sal_Char * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen, sal_Int32 shortenedLen ) ;
 ...
 */
	sal_Int32  rtl_str_reverseCompare_WithLength( const sal_Char * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
	sal_Int32  rtl_str_compareIgnoreAsciiCase( const sal_Char * first, const sal_Char * second ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_str_compareIgnoreAsciiCase_WithLength( const sal_Char * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen ) ;
...
/** Compare two strings with a maximum count of characters, ignoring the case
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_str_shortenedCompareIgnoreAsciiCase_WithLength( const sal_Char * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen, sal_Int32 shortenedLen ) ;
 ...
 */
sal_Int32  rtl_str_hashCode( const sal_Char * str ) ;
...
/** Return a hash code for a string.
    ...
    a hash code for the given string.
 */
sal_Int32  rtl_str_hashCode_WithLength( const sal_Char * str, sal_Int32 len ) ;
 ...
 */
sal_Int32  rtl_str_indexOfChar( const sal_Char * str, sal_Char ch ) ;
...
/** Search for the first occurrence of a character within a string.
    ...
    string, or -1 if the character does not occur.
 */
sal_Int32  rtl_str_indexOfChar_WithLength( const sal_Char * str, sal_Int32 len, sal_Char ch ) ;
 ...
 */
sal_Int32  rtl_str_lastIndexOfChar( const sal_Char * str, sal_Char ch ) ;
...
/** Search for the last occurrence of a character within a string.
    ...
    always smaller than the string length.
 */
sal_Int32  rtl_str_lastIndexOfChar_WithLength( const sal_Char * str, sal_Int32 len, sal_Char ch ) ;
 ...
 */
sal_Int32  rtl_str_indexOfStr( const sal_Char * str, const sal_Char * subStr ) ;
...
/** Search for the first occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_str_indexOfStr_WithLength( const sal_Char * str, sal_Int32 len, const sal_Char * subStr, sal_Int32 subLen ) ;
...
/** Search for the last occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_str_lastIndexOfStr( const sal_Char * str, const sal_Char * subStr ) ;
...
/** Search for the last occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_str_lastIndexOfStr_WithLength( const sal_Char * str, sal_Int32 len, const sal_Char * subStr, sal_Int32 subLen ) ;
...
/** Replace all occurrences of a single character within a string.
    ...
    the new character.
 */
void  rtl_str_replaceChar( sal_Char * str, sal_Char oldChar, sal_Char newChar ) ;
...
/** Replace all occurrences of a single character within a string.
    ...
    the new character.
 */
void  rtl_str_replaceChar_WithLength( sal_Char * str, sal_Int32 len, sal_Char oldChar, sal_Char newChar ) ;
...
/** Convert all ASCII uppercase letters to lowercase within a string.
    ...
    a null-terminated string.
 */
void  rtl_str_toAsciiLowerCase( sal_Char * str ) ;
...
/** Convert all ASCII uppercase letters to lowercase within a string.
    ...
    the length of the string.
 */
void  rtl_str_toAsciiLowerCase_WithLength( sal_Char * str, sal_Int32 len ) ;
...
/** Convert all ASCII lowercase letters to uppercase within a string.
    ...
    a null-terminated string.
 */
void  rtl_str_toAsciiUpperCase( sal_Char * str ) ;
...
/** Convert all ASCII lowercase letters to uppercase within a string.
    ...
    the length of the string.
 */
void  rtl_str_toAsciiUpperCase_WithLength( sal_Char * str, sal_Int32 len ) ;
 ...
 */
sal_Int32  rtl_str_trim( sal_Char * str ) ;
...
/** Remove white space from both ends of the string.
    ...
    the new length of the string.
 */
sal_Int32  rtl_str_trim_WithLength( sal_Char * str, sal_Int32 len ) ;
...
/** Create the string representation of a boolean.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfBoolean( sal_Char * str, sal_Bool b ) ;
...
/** Create the string representation of a character.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfChar( sal_Char * str, sal_Char ch ) ;
...
/** Create the string representation of an integer.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfInt32( sal_Char * str, sal_Int32 i, sal_Int16 radix ) ;
...
/** Create the string representation of a long integer.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfInt64( sal_Char * str, sal_Int64 l, sal_Int16 radix ) ;
...
/** Create the string representation of a float.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfFloat( sal_Char * str, float f ) ;
...
/** Create the string representation of a double.
    ...
    the length of the string.
 */
sal_Int32  rtl_str_valueOfDouble( sal_Char * str, double d ) ;
 ...
 */
sal_Bool  rtl_str_toBoolean( const sal_Char * str ) ;
 ...
 */
sal_Int32  rtl_str_toInt32( const sal_Char * str, sal_Int16 radix ) ;
#ifdef AVS
 ...
 */
sal_Int64  rtl_str_toInt64( const sal_Char * str, sal_Int16 radix ) ;
#endif
/** Interpret a string as a float.
    ...
    represent a float.
 */
float  rtl_str_toFloat( const sal_Char * str ) ;
...
/** Interpret a string as a double.
    ...
    represent a double.
 */
double  rtl_str_toDouble( const sal_Char * str ) ;
...
/** Increment the reference count of a string.
    ...
    a string.
 */
void  rtl_string_acquire( rtl_String * str ) ;
...
/** Decrement the reference count of a string.
    ...
    a string.
 */
void  rtl_string_release( rtl_String * str ) ;
...
/** Allocate a new string containing no characters.
    ...
    string.
 */
void  rtl_string_new( rtl_String ** newStr ) ;
 ...
 */
void  rtl_string_new_WithLength( rtl_String ** newStr, sal_Int32 len ) ;
...
/** Allocate a new string that contains a copy of another string.
    ...
    a valid string.
 */
void  rtl_string_newFromString( rtl_String ** newStr, const rtl_String * value ) ;
 ...
 */
void  rtl_string_newFromStr( rtl_String ** newStr, const sal_Char * value ) ;
 ...
 */
void  rtl_string_newFromStr_WithLength( rtl_String ** newStr, const sal_Char * value, sal_Int32 len ) ;
...
/** Assign a new value to a string.
    ...
    a valid string.
 */
void  rtl_string_assign( rtl_String ** str, rtl_String * rightValue ) ;
...
/** Return the length of a string.
    ...
    the length of the string.
 */
sal_Int32  rtl_string_getLength( const rtl_String * str ) ;
...
/** Create a new string that is the concatenation of two other strings.
    ...
    a valid string.
 */
void  rtl_string_newConcat( rtl_String ** newStr, rtl_String * left, rtl_String * right ) ;
 ...
 */
void  rtl_string_newReplaceStrAt( rtl_String ** newStr, rtl_String * str, sal_Int32 idx, sal_Int32 count, rtl_String * subStr ) ;
...
/** Create a new string by replacing all occurrences of a single character
    ...
    the new character.
 */
void  rtl_string_newReplace( rtl_String ** newStr, rtl_String * str, sal_Char oldChar, sal_Char newChar ) ;
...
/** Create a new string by converting all ASCII uppercase letters to lowercase
    ...
    a valid string.
 */
void  rtl_string_newToAsciiLowerCase( rtl_String ** newStr, rtl_String * str ) ;
...
/** Create a new string by converting all ASCII lowercase letters to uppercase
    ...
    a valid string.
 */
void  rtl_string_newToAsciiUpperCase( rtl_String ** newStr, rtl_String * str ) ;
...
/** Create a new string by removing white space from both ends of another
    ...
    a valid string.
 */
void  rtl_string_newTrim( rtl_String ** newStr, rtl_String * str ) ;
 ...
 */
sal_Int32  rtl_string_getToken( rtl_String ** newStr , rtl_String * str, sal_Int32 token, sal_Char cTok, sal_Int32 idx ) ;
...
/** Create a new byte string by converting a Unicode string, using a specific
    ...
    details.
 */
void  rtl_uString2String( rtl_String ** newStr, const sal_Unicode * str, sal_Int32 len, rtl_TextEncoding encoding, sal_uInt32 convertFlags ) ;
