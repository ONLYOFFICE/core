========================================================================
    ACTIVE TEMPLATE LIBRARY : ASCImageEditor Project Overview
========================================================================

AppWizard has created this ASCImageEditor project for you to use as the starting point for
...
_ASCImageEditor.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ASCImageEditor.h)
        GUID definitions                                (_ASCImageEditor_i.c)
        A type library                                  (_ASCImageEditor.tlb)
        Marshaling code                                 (_ASCImageEditor_p.c and dlldata.c)
ASCImageEditor.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named ASCImageEditor.pch and a precompiled types file named StdAfx.obj.
...
ASCImageEditorps.vcproj
	...
	dlldata.c, ASCImageEditor_i.c and ASCImageEditor_p.c which are required
	to build the proxy/stub DLL.

ASCImageEditorps.def
    This module definition file provides the linker with information about the exports
