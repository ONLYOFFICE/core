...
static double Clock() 
{
    ...
    // oTime - текущее врем€(в смысле oFreq)
...
// ƒелим nA на nB и округл€ем в большую сторону
static __inline int CeilDiv(int nA, int nB) 
{
	return (nA + nB - 1) / nB;
}

// ƒелим nA на 2^nB и округл€ем в большую сторону
static __inline int CeilDivPow2(int nA, int nB) 
{
	return (nA + (1 << nB) - 1) >> nB;
}

// ƒелим nA на 2^nB и округл€ем в меньшую сторону
static __inline int FloorDivPow2(int nA, int nB) 
{
	return nA >> nB;
}

// Ѕерем логарифм по основанию 2 от числа nA и округл€ем в меньшую сторону
...
// ѕримен€ем обратимое много-компонентное преобразование к изображению (Annex G.2.1)
...
// ѕримен€ем обратимое много-компонентное обратное преобазование к изображению (Annex G.2.2)
...
// ѕримен€ем необратимое много-компонентное преобразование к изображению (Annex G.3.1)
...
// ѕримен€ем необратимое много-компонентное обратное преобазование к изображению (Annex G.3.2)
