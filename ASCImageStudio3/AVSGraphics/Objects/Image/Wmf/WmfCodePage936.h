#ifndef _WMF_CODE_PAGE_936_H
#define _WMF_CODE_PAGE_936_H
...
struct TMSCP936_Pair
{
	unsigned short ushCode;
	unsigned short ushUnicode;
};

static const TMSCP932_Pair c_aoUnicodeMapCP936WithLeadByte[] =
{
...
static unsigned short CP936_Find(unsigned short ushCode)
{
	TMSCP936_Pair *pPair = (TMSCP936_Pair *)c_aoUnicodeMapCP936WithLeadByte;
...
static CStringW CP936_CharToUnicode(const char *sString)
{
	...
	for ( int nIndex = 0; nIndex < nLen; nIndex++ )
	{
		...
		unsigned short ushUnicode = c_anUnicodeMapCP936[unCode];

		if ( -1 == nLeadByte )
		{
			if ( MSCP936_LEAD_CHAR != ushUnicode )
			{
		...
		else
		{
			...
			wsString[nIndex] = CP936_Find( ushCode );
		}
	}
