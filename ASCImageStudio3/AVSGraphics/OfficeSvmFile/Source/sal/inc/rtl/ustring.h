 ...
 */
sal_Int32  rtl_ustr_getLength( const sal_Unicode * str ) ;
 ...
 */
sal_Int32  rtl_ustr_compare( const sal_Unicode * first, const sal_Unicode * second ) ;
...
/** Compare two strings.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_ustr_compare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Unicode * second, sal_Int32 secondLen ) ;
 ...
 */
sal_Int32  rtl_ustr_shortenedCompare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Unicode * second, sal_Int32 secondLen, sal_Int32 shortenedLen ) ;
 ...
 */
sal_Int32  rtl_ustr_reverseCompare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Unicode * second, sal_Int32 secondLen ) ;
...
sal_Bool  rtl_ustr_asciil_reverseEquals_WithLength( const sal_Unicode * first, const sal_Char * second, sal_Int32 len ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_ustr_compareIgnoreAsciiCase( const sal_Unicode * first, const sal_Unicode * second ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_ustr_compareIgnoreAsciiCase_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Unicode * second, sal_Int32 secondLen ) ;
...
/** Compare two strings with a maximum count of characters, ignoring the case
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_ustr_shortenedCompareIgnoreAsciiCase_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Unicode * second, sal_Int32 secondLen, sal_Int32 shortenedLen ) ;
...
/** Compare two strings.
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_ustr_ascii_compare( const sal_Unicode * first, const sal_Char * second ) ;
...
/** Compare two strings.
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_ustr_ascii_compare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Char * second ) ;
...
/** Compare two strings with a maximum count of characters.
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_ustr_ascii_shortenedCompare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 shortenedLen ) ;
...
/** Compare two strings from back to front.
    ...
    first string compares greater than the second string.
 */
sal_Int32  rtl_ustr_asciil_reverseCompare_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 secondLen ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_ustr_ascii_compareIgnoreAsciiCase( const sal_Unicode * first, const sal_Char * second ) ;
...
/** Compare two strings, ignoring the case of ASCII characters.
    ...
    string is greater than the second string.
 */
sal_Int32  rtl_ustr_ascii_compareIgnoreAsciiCase_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Char * second ) ;
...
/** Compare two strings with a maximum count of characters, ignoring the case
    ...
    substring is greater than the second substring.
 */
sal_Int32  rtl_ustr_ascii_shortenedCompareIgnoreAsciiCase_WithLength( const sal_Unicode * first, sal_Int32 firstLen, const sal_Char * second, sal_Int32 shortenedLen ) ;
 ...
 */
sal_Int32  rtl_ustr_hashCode( const sal_Unicode * str ) ;
...
/** Return a hash code for a string.
    ...
    a hash code for the given string.
 */
sal_Int32  rtl_ustr_hashCode_WithLength( const sal_Unicode * str, sal_Int32 len ) ;
 ...
 */
sal_Int32  rtl_ustr_indexOfChar( const sal_Unicode * str, sal_Unicode ch ) ;
...
/** Search for the first occurrence of a character within a string.
    ...
    string, or -1 if the character does not occur.
 */
sal_Int32  rtl_ustr_indexOfChar_WithLength( const sal_Unicode * str, sal_Int32 len, sal_Unicode ch ) ;
 ...
 */
sal_Int32  rtl_ustr_lastIndexOfChar( const sal_Unicode * str, sal_Unicode ch ) ;
...
/** Search for the last occurrence of a character within a string.
    ...
    always smaller than the string length.
 */
sal_Int32  rtl_ustr_lastIndexOfChar_WithLength( const sal_Unicode * str, sal_Int32 len, sal_Unicode ch ) ;
 ...
 */
sal_Int32  rtl_ustr_indexOfStr( const sal_Unicode * str, const sal_Unicode * subStr ) ;
...
/** Search for the first occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_ustr_indexOfStr_WithLength( const sal_Unicode * str, sal_Int32 len, const sal_Unicode * subStr, sal_Int32 subLen ) ;
...
/** Search for the last occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_ustr_lastIndexOfStr( const sal_Unicode * str, const sal_Unicode * subStr ) ;
...
/** Search for the last occurrence of a substring within a string.
    ...
    of the substring within the string, or -1 if the substring does not occur.
 */
sal_Int32  rtl_ustr_lastIndexOfStr_WithLength( const sal_Unicode * str, sal_Int32 len, const sal_Unicode * subStr, sal_Int32 subLen ) ;
...
/** Replace all occurrences of a single character within a string.
    ...
    the new character.
 */
void  rtl_ustr_replaceChar( sal_Unicode * str, sal_Unicode oldChar, sal_Unicode newChar ) ;
...
/** Replace all occurrences of a single character within a string.
    ...
    the new character.
 */
void  rtl_ustr_replaceChar_WithLength( sal_Unicode * str, sal_Int32 len, sal_Unicode oldChar, sal_Unicode newChar ) ;
...
/** Convert all ASCII uppercase letters to lowercase within a string.
    ...
    a null-terminated string.
 */
void  rtl_ustr_toAsciiLowerCase( sal_Unicode * str ) ;
...
/** Convert all ASCII uppercase letters to lowercase within a string.
    ...
    the length of the string.
 */
void  rtl_ustr_toAsciiLowerCase_WithLength( sal_Unicode * str, sal_Int32 len ) ;
...
/** Convert all ASCII lowercase letters to uppercase within a string.
    ...
    a null-terminated string.
 */
void  rtl_ustr_toAsciiUpperCase( sal_Unicode * str ) ;
...
/** Convert all ASCII lowercase letters to uppercase within a string.
    ...
    the length of the string.
 */
void  rtl_ustr_toAsciiUpperCase_WithLength( sal_Unicode * str, sal_Int32 len ) ;
 ...
 */
sal_Int32  rtl_ustr_trim( sal_Unicode * str ) ;
...
/** Remove white space from both ends of the string.
    ...
    the new length of the string.
 */
sal_Int32  rtl_ustr_trim_WithLength( sal_Unicode * str, sal_Int32 len ) ;
...
/** Create the string representation of a boolean.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfBoolean( sal_Unicode * str, sal_Bool b ) ;
...
/** Create the string representation of a character.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfChar( sal_Unicode * str, sal_Unicode ch ) ;
...
/** Create the string representation of an integer.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfInt32( sal_Unicode * str, sal_Int32 i, sal_Int16 radix ) ;
...
/** Create the string representation of a long integer.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfInt64( sal_Unicode * str, sal_Int64 l, sal_Int16 radix ) ;
...
/** Create the string representation of a float.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfFloat( sal_Unicode * str, float f ) ;
...
/** Create the string representation of a double.
    ...
    the length of the string.
 */
sal_Int32  rtl_ustr_valueOfDouble( sal_Unicode * str, double d ) ;
 ...
 */
sal_Bool  rtl_ustr_toBoolean( const sal_Unicode * str ) ;
 ...
 */
sal_Int32  rtl_ustr_toInt32( const sal_Unicode * str, sal_Int16 radix ) ;
#ifdef AVS
 ...
 */
sal_Int64  rtl_ustr_toInt64( const sal_Unicode * str, sal_Int16 radix ) ;
#endif
/** Interpret a string as a float.
    ...
    represent a float.
 */
float  rtl_ustr_toFloat( const sal_Unicode * str ) ;
...
/** Interpret a string as a double.
    ...
    represent a double.
 */
double  rtl_ustr_toDouble( const sal_Unicode * str ) ;
...
/** Increment the reference count of a string.
    ...
    a string.
 */
void  rtl_uString_acquire( rtl_uString * str ) ;
...
/** Decrement the reference count of a string.
    ...
    a string.
 */
void  rtl_uString_release( rtl_uString * str ) ;
...
/** Allocate a new string containing no characters.
    ...
    string.
 */
void  rtl_uString_new( rtl_uString ** newStr ) ;
 ...
 */
void  rtl_uString_new_WithLength( rtl_uString ** newStr, sal_Int32 nLen ) ;
...
/** Allocate a new string that contains a copy of another string.
    ...
    a valid string.
 */
void  rtl_uString_newFromString( rtl_uString ** newStr, const rtl_uString * value ) ;
 ...
 */
void  rtl_uString_newFromStr( rtl_uString ** newStr, const sal_Unicode * value ) ;
 ...
 */
void  rtl_uString_newFromStr_WithLength( rtl_uString ** newStr, const sal_Unicode * value, sal_Int32 len ) ;
 ...
 */
void  rtl_uString_newFromAscii( rtl_uString ** newStr, const sal_Char * value ) ;
...
/** Allocate a new string from an array of Unicode code points.
    ...
    @since UDK 3.2.7
*/
void  rtl_uString_newFromCodePoints(
...
/** Assign a new value to a string.
    ...
    a valid string.
 */
void  rtl_uString_assign( rtl_uString ** str, rtl_uString * rightValue ) ;
...
/** Return the length of a string.
    ...
    the length of the string.
 */
sal_Int32  rtl_uString_getLength( const rtl_uString * str ) ;
...
/** Create a new string that is the concatenation of two other strings.
    ...
    a valid string.
 */
void  rtl_uString_newConcat( rtl_uString ** newStr, rtl_uString * left, rtl_uString * right ) ;
 ...
 */
void  rtl_uString_newReplaceStrAt( rtl_uString ** newStr, rtl_uString * str, sal_Int32 idx, sal_Int32 count, rtl_uString * subStr ) ;
...
/** Create a new string by replacing all occurrences of a single character
    ...
    the new character.
 */
void  rtl_uString_newReplace( rtl_uString ** newStr, rtl_uString * str, sal_Unicode oldChar, sal_Unicode newChar ) ;
...
/** Create a new string by converting all ASCII uppercase letters to lowercase
    ...
    a valid string.
 */
void  rtl_uString_newToAsciiLowerCase( rtl_uString ** newStr, rtl_uString * str ) ;
...
/** Create a new string by converting all ASCII lowercase letters to uppercase
    ...
    a valid string.
 */
void  rtl_uString_newToAsciiUpperCase( rtl_uString ** newStr, rtl_uString * str ) ;
...
/** Create a new string by removing white space from both ends of another
    ...
    a valid string.
 */
void  rtl_uString_newTrim( rtl_uString ** newStr, rtl_uString * str ) ;
 ...
 */
sal_Int32  rtl_uString_getToken( rtl_uString ** newStr , rtl_uString * str, sal_Int32 token, sal_Unicode cTok, sal_Int32 idx ) ;
...
/** Create a new Unicode string by converting a byte string, using a specific
    ...
    details.
 */
void  rtl_string2UString( rtl_uString ** newStr, const sal_Char * str, sal_Int32 len, rtl_TextEncoding encoding, sal_uInt32 convertFlags ) ;
...
/** Return a canonical representation for a string.
    ...
    @since UDK 3.2.7
 */
void  rtl_uString_intern( rtl_uString ** newStr,
                                  rtl_uString  * str) ;
...
/** Return a canonical representation for a string.
    ...
    @since UDK 3.2.7
 */
void  rtl_uString_internConvert( rtl_uString   ** newStr,
                                         const sal_Char * str,
                                         sal_Int32        len,
...
sal_Bool  rtl_convertStringToUString(
    ...
    rtl_TextEncoding encoding, sal_uInt32 flags) ;
#ifdef AVS
#ifdef __cplusplus
}
#endif
