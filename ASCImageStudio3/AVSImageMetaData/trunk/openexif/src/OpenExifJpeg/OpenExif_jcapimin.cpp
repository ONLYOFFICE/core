...
GLOBAL(void)
openexif_jpeg_CreateCompress (j_compress_ptr cinfo, int version, size_t structsize)
{
  int i;
...
GLOBAL(void)
openexif_jpeg_destroy_compress (j_compress_ptr cinfo)
{
...
GLOBAL(void)
openexif_jpeg_abort_compress (j_compress_ptr cinfo)
{
...
GLOBAL(void)
openexif_jpeg_suppress_tables (j_compress_ptr cinfo, boolean suppress)
{
  int i;
  JQUANT_TBL * qtbl;
  JHUFF_TBL * htbl;
...
GLOBAL(void)
openexif_jpeg_finish_compress (j_compress_ptr cinfo)
{
  JDIMENSION iMCU_row;
...
GLOBAL(void)
openexif_jpeg_write_marker (j_compress_ptr cinfo, int marker,
...
GLOBAL(void)
openexif_jpeg_write_m_header (j_compress_ptr cinfo, int marker, unsigned int datalen)
{
  if (cinfo->next_scanline != 0 ||
      (cinfo->global_state != CSTATE_SCANNING &&
       cinfo->global_state != CSTATE_RAW_OK &&
...
GLOBAL(void)
openexif_jpeg_write_m_byte (j_compress_ptr cinfo, int val)
{
...
GLOBAL(void)
openexif_jpeg_write_tables (j_compress_ptr cinfo)
{
