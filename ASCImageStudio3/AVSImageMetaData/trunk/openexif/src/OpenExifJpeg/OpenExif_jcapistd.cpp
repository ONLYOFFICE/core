...
GLOBAL(void)
openexif_jpeg_start_compress (j_compress_ptr cinfo, boolean write_all_tables)
{
...
GLOBAL(JDIMENSION)
openexif_jpeg_write_scanlines (j_compress_ptr cinfo, JSAMPARRAY scanlines,
...
GLOBAL(JDIMENSION)
openexif_jpeg_write_raw_data (j_compress_ptr cinfo, JSAMPIMAGE data,
		     JDIMENSION num_lines)
{
