...
typedef JMETHOD(void, inverse_DCT_method_ptr,
		(j_decompress_ptr cinfo, openexif_jpeg_component_info * compptr,
		 JCOEFPTR coef_block,
...
#define openexif_jpeg_zigzag_order	jZIGTable
#define openexif_jpeg_natural_order	jZAGTable
...
EXTERN(void) openexif_jinit_memory_mgr JPP((j_common_ptr cinfo));

/* Utility routines in jutils.c */
EXTERN(long) openexif_jdiv_round_up JPP((long a, long b));
EXTERN(long) openexif_jround_up JPP((long a, long b));
EXTERN(void) openexif_jcopy_sample_rows JPP((JSAMPARRAY input_array, int source_row,
				    JSAMPARRAY output_array, int dest_row,
				    int num_rows, JDIMENSION num_cols));
EXTERN(void) openexif_jcopy_block_row JPP((JBLOCKROW input_row, JBLOCKROW output_row,
				  JDIMENSION num_blocks));
EXTERN(void) openexif_jzero_far JPP((void FAR * target, size_t bytestozero));
