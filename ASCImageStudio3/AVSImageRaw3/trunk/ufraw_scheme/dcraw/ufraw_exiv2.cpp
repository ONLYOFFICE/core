/*!
*	\file	ufraw_exiv2.cpp
*	\brief	Read the EXIF data from the RAW file using exiv2 (Адаптация Unidentified Flying Raw converter для COM-компоненты AVSImageRaw3)
*	За основу взят файл ufraw_exiv2.cc из пакета ufraw-0.14.1.tar.gz
*	Новые версии доступны тут: http://ufraw.sourceforge.net/
* 
*	Базовый файл, относительно которого вносились правки:
*		./base/ufraw_exiv2.ccb
*
