/*!	\file	dcrawcommon.h
 *	\brief	Общий заголовок для файлов dcraw
 *
 */

#pragma once

#define S_PPM_THUMBNAIL MAKE_HRESULT(0, FACILITY_NULL, 2)
...
#define DCRAW_SWAP(a,b) do {  a=a+b; b=a-b; a=a-b;} while (0);
...
#ifdef _DEBUG
#define merror(P,M) merror_((P),(M))
#else
#define merror(P,M) merror_((P),"memory error")
#endif
