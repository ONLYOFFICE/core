...
#import "../../../../AVS/Redist/AVSVideoOutput3.dll"			named_guids rename_namespace("VideoOutput"), raw_interfaces_only 

// include libraries

#pragma comment(lib, "C:\\Program Files (x86)\\Microsoft DirectX SDK (2004)\\lib\\ddraw.lib")
