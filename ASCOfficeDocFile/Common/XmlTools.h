...
namespace XMLTools
{
	...
	public:
		...
		bool FindChild( const XMLElement<T>& element )
		{
			...
			for ( list<XMLElement<T>>::iterator iter = m_Elements.begin(); iter != m_Elements.end(); iter++ )
			{
				if ( *iter == element )
				{
					result = true;
		...
		bool operator == ( const XMLElement<T>& element )
		{
			...
			{
				map<basic_string<T>, basic_string<T>>::iterator thisIter = m_AttributeMap.begin();
				map<basic_string<T>, basic_string<T>>::const_iterator elementIter = element.m_AttributeMap.begin();
			...
			{
				list<XMLElement<T>>::iterator thisIter = m_Elements.begin();
				list<XMLElement<T>>::const_iterator elementIter = element.m_Elements.begin();		  
		...
		basic_string<T> GetXMLString()
		{
			...
			{
				for ( map<basic_string<T>, basic_string<T>>::iterator iter = m_AttributeMap.begin(); iter != m_AttributeMap.end(); iter++ )
				{
					xmlString += basic_string<T>( _T( " " ) );
