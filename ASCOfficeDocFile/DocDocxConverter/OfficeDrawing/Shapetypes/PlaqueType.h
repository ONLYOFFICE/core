  ...
  class PlaqueType: public ShapeType
  {
    public: 
      ...
      ShapeType(msosptPlaque)
      {
        ...
        this->Joins = miter;
        this->Path = _T( "m@0,qy0@0l0@2qx@0,21600l@1,21600qy21600@2l21600@0qx@1,xe" );
        this->Formulas.push_back( _T( "val #0" ) );
        this->Formulas.push_back( _T( "sum width 0 #0" ) );
        this->Formulas.push_back( _T( "sum height 0 #0" ) );
        this->Formulas.push_back( _T( "prod @0 7071 10000" ) );
		...
		this->AdjustmentValues = _T( "3600" );
        this->ConnectorLocations = _T( "@8,0;0,@9;@8,@7;@6,@9" );

        this->TextBoxRectangle = _T( "@3,@3,@4,@5" );
        Handle HandleOne;
