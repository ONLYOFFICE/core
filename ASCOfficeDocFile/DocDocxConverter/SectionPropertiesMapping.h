...
{
	static const WCHAR SectionTypeMap[5][11] =
	{
		_T( "continuous" ),
		_T( "nextColumn" ),
		_T( "nextPage" ),
	...
	static const WCHAR PageOrientationMap[3][10] =
	{
		_T( "0" ),
		_T( "portrait" ),
		_T( "landscape" )
	...
	static const WCHAR DocGridTypeMap[4][14] =
	{
		_T( "Default" ),
		_T( "linesAndChars" ),
		_T( "lines" ),
	...
	static const WCHAR FootnoteRestartCodeMap[3][11] =
	{
		_T( "continuous" ),
		_T( "eachSect" ),
		_T( "eachPage" )
	...
	static const WCHAR EndnoteRestartCodeMap[3][11] =
	{
		_T( "continuous" ),
		_T( "eachSect" ),
		_T( "eachPage" )
	...
	static const WCHAR PageNumberFormatCodeMap[42][29] =
	{
		_T( "Decimal" ),
		_T( "upperRoman" ),
		_T( "lowerRoman" ),
	...
	static const WCHAR TextVerticalAlignment[4][7] = 
	{
		_T( "top" ),
		_T( "center" ),
		_T( "both" ),
...
namespace DocFileFormat
{
	...
	public:
		...
		SectionPropertiesMapping (XMLTools::XMLElement<WCHAR>* sectPr, ConversionContext* ctx, int nSelectProperties);
	...
	private:
		...
		void AppendRef (XMLTools::XMLElement<WCHAR>* pBaseNode, const WCHAR* element, const WCHAR* refType, const WCHAR* refId);

		BOOL WriteSectionStory (CharacterRange* pRange, const std::wstring& StoryType, const std::wstring& Story);

	private: 

		XMLTools::XMLElement<WCHAR>*	m_pXmlNode;
		BOOL							m_bDeleteNode;
