...
namespace ASCDocFileFormat
{
	...
	public:
		...
		explicit Brc80( byte _dptLineWidth, byte _brcType, byte _ico, byte _dptSpace, bool fShadow, bool fFrame )
		{
			if ( _dptLineWidth < 2 )
			{
	...
	public:
		Brc80MayBeNil():
		  ...
		  Brc80MayBeNil( byte _dptLineWidth, byte _brcType, byte _ico, byte _dptSpace, bool fShadow, bool fFrame ):  brc80( _dptLineWidth, _brcType, _ico, _dptSpace, fShadow, fFrame )
		  {
