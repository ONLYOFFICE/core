...
namespace ASCDocFileFormat
{
	...
	public:
		...
		bytes(NULL), cb(0)
		{
			...
			if ( bytes != NULL )
			{
				brcTop					=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 0 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
				brcLeft					=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 4 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
				brcBottom				=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 8 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
				brcRight				=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 12 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
				brcHorizontalInside		=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 16 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
				brcVerticalInside		=	Brc80MayBeNil( FormatUtils::BytesToUInt32( bytes, ( 20 + sizeof(unsigned short) + sizeof(byte) ), prlSize ) );
