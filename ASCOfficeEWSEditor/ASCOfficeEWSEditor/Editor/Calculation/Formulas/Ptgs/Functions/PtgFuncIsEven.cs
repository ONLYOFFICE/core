...
namespace ASCOfficeEWSEditor.Editor.Calculation.Formulas.Ptgs.Functions
{
    internal class PtgFuncIsEven : PtgFuncFixed
    {
        public override DataObjects.IDataObject Calculate(LinkedList<DataObjects.IDataObject> argv, PreferredResultType result_type)
        {
            ...
            return new DataObjects.ObjectBoolean((((int)num_arg.Value) & 1) == 0);
        }

        public override string ToString() { return "ISEVEN"; }
        ...
        public override string ArgumentsTip { get { return "ISEVEN(number)"; } }
    }
}
