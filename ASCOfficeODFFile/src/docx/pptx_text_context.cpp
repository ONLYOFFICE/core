...
pptx_text_context::Impl::Impl(odf::styles_container & styles): paragraphs_cout_(0),styles_(styles),
...
void pptx_text_context::Impl::end_span() //odf корявенько написан - возможны повторы стилей в последовательных кусках текста
...
std::wstring pptx_text_context::Impl::dump_text()
{
...
pptx_text_context::pptx_text_context(odf::styles_container & _styles): impl_(new pptx_text_context::Impl(_styles))
{}
...
bool pptx_text_context::is_drawing_context()
{
