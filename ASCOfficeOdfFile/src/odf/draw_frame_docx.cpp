                      ...
                      const graphic_format_properties & graphicProperties)
{
	...
	//todooo пока не €сно как прив€зать к определеной странице в документе ...
    ...
    // TODO : проверить, значени€ в процентах что именно означают
	...
	//if (anchor_page_number && pageHeight)....так нельз€ .. только в пределах текущей страницы :(
	//{
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (!drawing.isInline)
    {
		...
		if (zIndex)//пор€док отрисовки объектов
        {
            if (*zIndex < 0) 
...
void draw_shape::docx_convert(oox::docx_conversion_context & Context)
{
	...
	drawing.additional	= additional_;//сюда могут добавитьс€ свойства ...
...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//нужно еще систему конрол€ - могут придте уже "использованные" линки с картинок - из колонтитулов (но на них уже использовали релсы)
	//дыра осталась если картинка в картинке - линк продублируетс€ с внутренней на внешнюю 
