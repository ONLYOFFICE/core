...
unsigned int  CatalogGetViewerPreference(Catalog pCatalog)
{
    ...
    oBool = (Boolean)DictGetItem( pPreferences, "HideToolbar", OCLASS_BOOLEAN);
    if ( oBool ) 
	{
		if ( oBool->bValue )
            nValue += HIDE_TOOLBAR;
    ...
    oBool = (Boolean)DictGetItem( pPreferences, "HideMenubar", OCLASS_BOOLEAN);
    if ( oBool ) 
	{
		if ( oBool->bValue )
            nValue += HIDE_MENUBAR;
    ...
    oBool = (Boolean)DictGetItem( pPreferences, "HideWindowUI", OCLASS_BOOLEAN);
    if ( oBool ) 
	{
		if ( oBool->bValue )
    ...
    oBool = (Boolean)DictGetItem( pPreferences, "FitWindow", OCLASS_BOOLEAN);
    if ( oBool ) 
	{
		if ( oBool->bValue )
            nValue += FIT_WINDOW;
    ...
    oBool = (Boolean)DictGetItem( pPreferences, "CenterWindow", OCLASS_BOOLEAN);
    if ( oBool ) 
	{
		if ( oBool->bValue )
