...
private:
	...
	CSimpleArray<TText              > m_arrTexts;       // Список текстов
	CSimpleArray<NSStructures::CFont> m_arrFonts;       // Список шрифтов к текстам
	CSimpleArray<TColor             > m_arrColors;      // Список текстовых цветов
	CSimpleArray<TMatrix            > m_arrMatrixes;    // Список матриц к текстам ( в матрицах изменяться должно только смещение )
	CSimpleArray<double             > m_arrCharSpacing; // Межсимвольный интервал
};
class CFontLoader
{
public:
