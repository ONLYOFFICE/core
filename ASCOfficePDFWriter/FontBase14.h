...
static const CharData c_aoCharDataCourier[316] = 
{
    {32, 0x0020, 600},
    {33, 0x0021, 600},
    {34, 0x0022, 600},
...
static const CharData c_aoCharDataCourierBold[316] = {
    {32, 0x0020, 600},
    {33, 0x0021, 600},
    {34, 0x0022, 600},
    {35, 0x0023, 600},
...
static const CharData c_aoCharDataCourierBoldOblique[316] = 
{
    {32, 0x0020, 600},
    {33, 0x0021, 600},
    {34, 0x0022, 600},
...
static const CharData c_aoCharDataCourierOblique[316] = 
{
    {32, 0x0020, 600},
    {33, 0x0021, 600},
    {34, 0x0022, 600},
...
static const CharData c_aoCharDataHelvetica[316 + 99] = 
{
    {32, 0x0020, 278},
    {33, 0x0021, 278},
    {34, 0x0022, 355},
...
static const CharData c_aoCharDataHelveticaBold[316] = 
{
    {32, 0x0020, 278},
    {33, 0x0021, 333},
    {34, 0x0022, 474},
...
static const CharData c_aoCharDataHelveticaBoldOblique[316] = 
{
    {32, 0x0020, 278},
    {33, 0x0021, 333},
    {34, 0x0022, 474},
...
static const CharData c_aoCharDataHelveticaOblique[316] = 
{
    {32, 0x0020, 278},
    {33, 0x0021, 278},
    {34, 0x0022, 355},
...
static const CharData c_aoCharDataTimes[316] = 
{
    {32, 0x0020, 250},
    {33, 0x0021, 333},
    {34, 0x0022, 408},
...
static const CharData c_aoCharDataTimesBold[316] = 
{
    {32, 0x0020, 250},
    {33, 0x0021, 333},
    {34, 0x0022, 555},
...
static const CharData c_aoCharDataTimesBoldItalic[316] = 
{
    {32, 0x0020, 250},
    {33, 0x0021, 389},
    {34, 0x0022, 555},
...
static const CharData c_aoCharDataTimesItalic[316] = 
{
    {32, 0x0020, 250},
    {33, 0x0021, 333},
    {34, 0x0022, 420},
...
static const CharData c_aoCharDataZapfDingbats[203] = 
{
    {32, 0x0020, 278},
    {33, 0x0021, 974},
    {34, 0x0022, 961},
...
static const CharData c_aoCharDataSymbol[190] = 
{
    {32, 0x0020, 250},
    {33, 0x0021, 333},
    {34, 0x0022, 713},
...
static const Base14FontDefData  c_aoBuiltinFonts[] = 
{
    {
        FONT_COURIER,
        c_aoCharDataCourier,
...
const   Base14FontDefData* Base14FontDefFindBuiltinData(const char *sFontName)
{
	...
	while ( c_aoBuiltinFonts[nIndex].sFontName ) 
	{
		if ( 0 == UtilsStrCmp( c_aoBuiltinFonts[ nIndex ].sFontName, sFontName ) )
            break;
        nIndex++;
    }

    return &c_aoBuiltinFonts[ nIndex ];
}
...
FontDef                    Base14FontDefNew            (MMgr oMMgr, const char *sFontName)
{
    ...
    const Base14FontDefData *pData = Base14FontDefFindBuiltinData( sFontName );

	if ( !pData->sFontName ) 
	{
		//SetError( oMMgr->oError, AVS_OFFICEPDFWRITER_ERROR_INVALID_FONT_NAME, 0);
		FontDefFree( pFontDef );
		return NULL;
	}

    char *pEndPointer = pFontDef->sBaseFont + LIMIT_MAX_NAME_LEN;
    ...
    unsigned long nRet = Type1FontDefSetWidths( pFontDef, pData->pWidthsTable );
	...
	pFontDef->oFontBox   = pData->oBox;
	pFontDef->nAscent    = pData->nAscent;
	pFontDef->nDescent   = pData->nDescent;
