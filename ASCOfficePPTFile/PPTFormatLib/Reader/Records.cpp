...
IRecord* CreateByType(SRecordHeader oHeader)
{
    ...
    CREATE_BY_TYPE(RECORD_TYPE_RoundTripTheme12Atom					, CRecordRoundTripThemeAtom)
    CREATE_BY_TYPE(RECORD_TYPE_RoundTripColorMapping12Atom			, CRecordRoundTripColorMappingAtom)
    ...
    CREATE_BY_TYPE(RECORD_TYPE_ANIMATIONINFO_ATOM           , CRecordAnimationInfoAtom)
    CREATE_BY_TYPE(RECORD_TYPE_ANIMATIONINFO                , CRecordAnimationInfoContainer)
