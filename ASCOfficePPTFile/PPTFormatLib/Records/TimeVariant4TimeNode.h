...
// A TimeDisplayType record that specifies the visibility of the time node in the user
// interface.
class CRecordTimeDisplayType : public CRecordTimeVariantInt {};


// A TimeMasterRelType record that specifies the relationship of a subordinate time
// node to its master time node.
...
// A TimeNodeTimeFilter record that specifies a time filter that transforms a given.
