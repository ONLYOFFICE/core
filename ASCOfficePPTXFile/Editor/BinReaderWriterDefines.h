...
#define DIAGRAM_LAYOUT_TYPE_NONE			0xA0
#define DIAGRAM_LAYOUT_TYPE_ALG				0xA1
#define DIAGRAM_LAYOUT_TYPE_CHOOSE			0xA2
#define DIAGRAM_LAYOUT_TYPE_CONSTRLST		0xA3
#define DIAGRAM_LAYOUT_TYPE_FOREACH			0xA4
#define DIAGRAM_LAYOUT_TYPE_LAYOUTNODE		0xA5
#define DIAGRAM_LAYOUT_TYPE_PRESOF			0xA6
#define DIAGRAM_LAYOUT_TYPE_RULELST			0xA7
#define DIAGRAM_LAYOUT_TYPE_SHAPE			0xA8
#define DIAGRAM_LAYOUT_TYPE_VARIABLELIST	0xA9
