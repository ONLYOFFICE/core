...
{
	class CWedgeRoundRectCallout : public CPPTXShape
	{
		public:
			CWedgeRoundRectCallout()
			{
				LoadFromXML(
					_T("<ooxml-shape>")
					...
					_T("<gdLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("<gd name=\"u1\" fmla=\"*/ ss adj3 100000\" />")
					  _T("<gd name=\"u2\" fmla=\"+- r 0 u1\" />")
					  _T("<gd name=\"v2\" fmla=\"+- b 0 u1\" />")
					  _T("<gd name=\"il\" fmla=\"*/ u1 29289 100000\" />")
					...
					_T("<pathLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  _T("<path>")
						_T("<moveTo>")
						  _T("<pt x=\"l\" y=\"u1\" />")
						_T("</moveTo>")
						_T("<arcTo wR=\"u1\" hR=\"u1\" stAng=\"cd2\" swAng=\"cd4\" />")
						_T("<lnTo>")
						  _T("<pt x=\"x1\" y=\"t\" />")
						_T("</lnTo>")
						_T("<lnTo>")
						...
						_T("<lnTo>")
						  _T("<pt x=\"u2\" y=\"t\" />")
						_T("</lnTo>")
						_T("<arcTo wR=\"u1\" hR=\"u1\" stAng=\"3cd4\" swAng=\"cd4\" />")
						_T("<lnTo>")
						  _T("<pt x=\"r\" y=\"y1\" />")
						_T("</lnTo>")
						_T("<lnTo>")
						...
						_T("<lnTo>")
						  _T("<pt x=\"r\" y=\"v2\" />")
						_T("</lnTo>")
						_T("<arcTo wR=\"u1\" hR=\"u1\" stAng=\"0\" swAng=\"cd4\" />")
						_T("<lnTo>")
						  _T("<pt x=\"x2\" y=\"b\" />")
						_T("</lnTo>")
						_T("<lnTo>")
						...
						_T("<lnTo>")
						  _T("<pt x=\"u1\" y=\"b\" />")
						_T("</lnTo>")
						_T("<arcTo wR=\"u1\" hR=\"u1\" stAng=\"cd4\" swAng=\"cd4\" />")
						_T("<lnTo>")
						  _T("<pt x=\"l\" y=\"y2\" />")
						_T("</lnTo>")
						_T("<lnTo>")
