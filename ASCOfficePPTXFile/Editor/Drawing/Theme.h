...
namespace PPT_FORMAT
{
	...
	public:
        ...
        std::vector<CRecordRoundTripThemeAtom*> m_arrZipXmlMaster;
        std::vector<CRecordRoundTripThemeAtom*> m_arrZipXmlNote;
        std::vector<CRecordRoundTripThemeAtom*> m_arrZipXmlHandout;
