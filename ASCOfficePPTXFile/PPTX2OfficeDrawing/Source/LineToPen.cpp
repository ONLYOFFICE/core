...
namespace PPTX2OfficeDrawing
{
	...
	void Converter::LineToPen(const PPTX::Logic::Ln& Line, NSPresentationEditor::CPen& Pen, DWORD BGRA)
	{
/*
		CColor m_oColor;
		BYTE m_nAlpha;
...
*/
		...
		{
			ColorConvert(Line.Fill.as<PPTX::Logic::SolidFill>().Color, Pen.m_oColor, BGRA);
