...
class CellRangeRef : public BiffStructTagged
{
...
public:
	...
	CellRangeRef();
	CellRangeRef(const _bstr_t& str_ref);
...
{
public:
	CellRangeRef_T(const _bstr_t& str_ref) : CellRangeRef(str_ref) {};
	...
	virtual const _bstr_t& getClassName() const { return NameProducer()();}
...
typedef CellRangeRef_T<Ref_name, WORD, BYTE, rel_Absent> Ref;
typedef CellRangeRef_T<Ref8_name, WORD, WORD, rel_Absent> Ref8;
typedef CellRangeRef_T<Ref8U_name, WORD, WORD, rel_Absent> Ref8U;
typedef CellRangeRef_T<RefU_name, WORD, BYTE, rel_Absent> RefU;
typedef CellRangeRef_T<Ref8U2007_name, DWORD, DWORD, rel_Absent> Ref8U2007;
typedef CellRangeRef_T<RFX_name, long, long, rel_Absent> RFX;
typedef CellRangeRef_T<RgceArea_name, WORD, WORD, rel_Present> RgceArea;
