...
Ftab_Cetab::Ftab_Cetab(const WORD func_index_init)
:	func_index(func_index_init)
{
}


void Ftab_Cetab::toXML(MSXML2::IXMLDOMElementPtr parent)
{
	MSXML2::IXMLDOMElementPtr own_tag = XMLSTUFF::makeXMLNode(isMacro() ? "Cetab" : "Ftab", parent);
...
// static
const std::wstring Ftab_Cetab::ValuesDetermination::getName(const WORD iftab)
{
...
// static
const long Ftab_Cetab::ValuesDetermination::getParamsNum(const WORD iftab)
{
	const ParamsFixedSet::index<sort_by_iftab>::type& iftab_index = getInst().params_fixed.get<sort_by_iftab>();
	const ParamsFixedSet::index<sort_by_iftab>::type::iterator found = iftab_index.find(iftab);
	if(iftab_index.end() != found)
...
// static
const WORD Ftab_Cetab::ValuesDetermination::getIndex(const std::wstring& func_name)
{
...
const WORD Ftab_Cetab::getIndex() const
{
	return func_index;
}
...
// static
const WORD Ftab_Cetab::recognizeFunction(const std::wstring& word)
{
