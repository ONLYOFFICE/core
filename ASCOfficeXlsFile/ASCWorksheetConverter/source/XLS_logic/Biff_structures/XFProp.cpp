...
void XFProp::toXML(MSXML2::IXMLDOMElementPtr parent)
{
...
const bool XFProp::fromXML(MSXML2::IXMLDOMElementPtr parent)
{
...
void XFProp::load(CFRecord& record)
{
	...
	//record.skipNBytes(cb - sizeof(cb) - sizeof(xfPropType));
	switch(xfPropType)
	{
		case 0x0000:
