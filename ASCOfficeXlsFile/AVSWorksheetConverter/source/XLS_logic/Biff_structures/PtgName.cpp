...
PtgName::PtgName(const DWORD index, const PtgDataType data_type)
:	nameindex(index),
...
void PtgName::assemble(AssemblerStack& ptg_stack, PtgQueue& extra_data, MSXML2::IXMLDOMElementPtr parent)
{
