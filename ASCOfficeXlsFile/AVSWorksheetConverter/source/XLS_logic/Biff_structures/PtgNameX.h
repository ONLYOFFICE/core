...
public:
	PtgNameX();
	PtgNameX(const std::wstring& word, MSXML2::IXMLDOMElementPtr parent, const PtgDataType data_type_init);
	...
	static const WORD fixed_id = 0x19;
private:
	void fromString(const std::wstring& word, MSXML2::IXMLDOMElementPtr parent);
