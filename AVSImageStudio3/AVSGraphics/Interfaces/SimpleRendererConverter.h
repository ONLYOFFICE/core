...
class CSimpleRendererConverter
{
protected:

	double						m_dNaturalWidth;
	double						m_dNaturalHeight;
		...
		case c_nWindingFillMode:
			{
				...
				if (m_oBrush.Type == c_BrushTypeTexture)
				{
					...
					if (NULL != m_pCache)
					{
						...
						pBrush = new Aggplus::CBrushTexture(pCacheImage->GetImage(), oMode);
					}
					else
					{
						pBrush = new Aggplus::CBrushTexture(m_oBrush.TexturePath, oMode);
					}
				}
				else
				{
		...
		case c_nEvenOddFillMode:
			{
				...
				if (m_oBrush.Type == c_BrushTypeTexture)
				{
					if (NULL != m_pCache)
					{
						...
						pBrush = new Aggplus::CBrushTexture(pCacheImage->GetImage(), /*(Aggplus::WrapMode)TextureMode*/Aggplus::WrapModeClamp);
					}
					else
					{
						pBrush = new Aggplus::CBrushTexture(m_oBrush.TexturePath, /*(Aggplus::WrapMode)TextureMode*/Aggplus::WrapModeClamp);
					}
				}
				else
				{
