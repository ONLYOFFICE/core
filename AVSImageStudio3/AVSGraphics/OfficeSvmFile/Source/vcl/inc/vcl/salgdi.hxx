...
#define HATCH_MAXSalPointS				1024
...
public:
    ...
    virtual ~SalGraphics();
#ifndef AVS_INSERT
virtual void SetOutputSizePixel( const Size& rNewSize) = 0;
#endif
protected:
    ...
    virtual void		drawPixel( long nX, long nY, SalColor nColor ) = 0;
    virtual void		drawLine( long nX1, long nY1, long nX2, long nY2 ) = 0;
    virtual void		drawRect( long nX, long nY, long nWidth, long nHeight ) = 0;
    virtual void		drawPolyLine( ULONG nSalPoints, const SalPoint* pPtAry ) = 0;
    virtual void		drawPolygon( ULONG nSalPoints, const SalPoint* pPtAry ) = 0;
    virtual void		drawPolyPolygon( sal_uInt32 nPoly, const sal_uInt32* pSalPoints, PCONSTSALPOINT* pPtAry ) = 0;
#ifdef AVS
...
#endif
    virtual sal_Bool	drawPolyLineBezier( ULONG nSalPoints, const SalPoint* pPtAry, const BYTE* pFlgAry ) = 0;
    virtual sal_Bool	drawPolygonBezier( ULONG nSalPoints, const SalPoint* pPtAry, const BYTE* pFlgAry ) = 0;
    virtual sal_Bool	drawPolyPolygonBezier( sal_uInt32 nPoly, const sal_uInt32* pSalPoints, const SalPoint* const* pPtAry, const BYTE* const* pFlgAry ) = 0;
#ifdef AVS
    ...
    virtual void		invert( ULONG nPoints, const Point* pPtAry, SalInvert nFlags ) = 0;
...
public:
    ...
    //             code SalPoints 0 to 255; must contain at least 256 members
	...
	BOOL					mirror( sal_uInt32 nSalPoints, const SalPoint *pPtAry, SalPoint *pPtAry2, const OutputDevice *pOutDev, bool bBack = false ) const;
	...
	basegfx::B2DSalPoint       mirror( const basegfx::B2DSalPoint& i_rSalPoint, const OutputDevice *pOutDev, bool bBack = false ) const;
    ...
    void                    DrawPixel( long nX, long nY, Color nSalColor, const OutputDevice *pOutDev );
    void                    DrawLine( long nX1, long nY1, long nX2, long nY2, const OutputDevice *pOutDev );
    void                    DrawRect( long nX, long nY, long nWidth, long nHeight, const OutputDevice *pOutDev );
    void                    DrawPolyLine( ULONG nSalPoints, const SalPoint* pPtAry, const OutputDevice *pOutDev );
    void                    DrawPolygon( ULONG nSalPoints, const SalPoint* pPtAry, const OutputDevice *pOutDev );
    void                    DrawPolyPolygon( sal_uInt32 nPoly,
                                             const sal_uInt32* pSalPoints,
...
#endif
    sal_Bool                DrawPolyLineBezier( ULONG nSalPoints,
                                                const SalPoint* pPtAry,
                                                const BYTE* pFlgAry,
                                                const OutputDevice *pOutDev );
    sal_Bool                DrawPolygonBezier( ULONG nSalPoints,
                                               const SalPoint* pPtAry,
                                               const BYTE* pFlgAry,
                                               const OutputDevice *pOutDev );
    ...
    void                    Invert( ULONG nSalPoints, const SalPoint* pPtAry, SalInvert nFlags, const OutputDevice *pOutDev );
