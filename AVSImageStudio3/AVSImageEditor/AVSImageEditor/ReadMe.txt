========================================================================
    ACTIVE TEMPLATE LIBRARY : AVSImageEditor Project Overview
========================================================================

AppWizard has created this AVSImageEditor project for you to use as the starting point for
...
_AVSImageEditor.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_AVSImageEditor.h)
        GUID definitions                                (_AVSImageEditor_i.c)
        A type library                                  (_AVSImageEditor.tlb)
        Marshaling code                                 (_AVSImageEditor_p.c and dlldata.c)
AVSImageEditor.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named AVSImageEditor.pch and a precompiled types file named StdAfx.obj.
...
AVSImageEditorps.vcproj
	...
	dlldata.c, AVSImageEditor_i.c and AVSImageEditor_p.c which are required
	to build the proxy/stub DLL.

AVSImageEditorps.def
    This module definition file provides the linker with information about the exports
