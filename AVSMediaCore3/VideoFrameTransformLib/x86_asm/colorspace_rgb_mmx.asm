...
; input
MAKE_COLORSPACE  fastconvert_bgr_to_yv12_mmx,0,    3,2,2,  BGR_TO_YV12,  3, -1
MAKE_COLORSPACE  fastconvert_bgra_to_yv12_mmx,0,   4,2,2,  BGR_TO_YV12,  4, -1

; output
MAKE_COLORSPACE  fastconvert_yv12_to_bgr_mmx,48,   3,8,2,  YV12_TO_BGR,  3, -1
MAKE_COLORSPACE  fastconvert_yv12_to_bgra_mmx,48,  4,8,2,  YV12_TO_BGR,  4, -1
