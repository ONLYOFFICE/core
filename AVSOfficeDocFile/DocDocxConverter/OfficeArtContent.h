...
namespace DocFileFormat
{
	...
	public:
		...
		OfficeArtContent (const FileInformationBlock* pFIB, IStream* pStream): m_pDrawingGroupData(NULL)
		{
			VirtualStreamReader oStearmReader(pStream);
			oStearmReader.Seek (pFIB->m_FibWord97.fcDggInfo, STREAM_SEEK_SET);
