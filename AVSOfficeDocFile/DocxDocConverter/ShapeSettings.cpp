...
namespace AVSDocFileFormat
{
	...
	BOOL CFillStyle::Read (const OOX::Logic::FillStyle& oXml)
	{
		...
		// ¬нимание - пор€док добавлени€ свойств очень важен ( добавл€ем по возрастанию ID )
...
namespace AVSDocFileFormat
{
	...
	BOOL CShadowStyle::Read (const OOX::Logic::Shadow& oXml)
	{
		...
		if (oXml.Matrix.is_init())			// данные формируютс€ не по спецификации
		{
...
namespace AVSDocFileFormat
{
	...
	//
	void CShapeSettings::SetUseBehind	(const OOX::Logic::ShapeStyle& refStyle)		//	объект располагаетс€ за текстом
	{
	...
	{
		// ¬нимание - пор€док добавлени€ свойств очень важен
