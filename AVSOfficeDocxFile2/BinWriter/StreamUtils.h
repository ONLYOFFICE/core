...
namespace Streams
{
	...
	public:
		...
		{
			return TRUE; // always allow to "peek" because we dont know exactly the size of the array
		}
		virtual BOOL Grow(int nGrowSize)
		{
			return TRUE; // always allow to "grow" because we dont know exactly the size of the array
		}
