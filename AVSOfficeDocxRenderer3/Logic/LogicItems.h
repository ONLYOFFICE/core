...
namespace NSDocx
{
	...
	public:
		...
		CLogicParagraph(const CDocxParagraph& oSrc)
		{
			m_eType = elitTextParagraph;
			m_oParagraph = oSrc;
		}
	...
	public:
		...
		virtual void ConvertToDocxPage(NSDocx::CFormat& oFormat)										= 0;
		...
		virtual void WriteTable(NSDocx::ILogicItem* pItem)  = 0;
		...
		virtual void CloseFile(NSDocx::CFormat& oFormat)		= 0;
	...
	public:
		virtual void CheckWatermark(CFormat& oFormat)
		{
			if (m_bIsDumpWatermark && (-1 != m_oInfoWatermark.m_lID))
			{
				...
				CDocxGraphicObject* pObject	= new CDocxGraphicObject();
