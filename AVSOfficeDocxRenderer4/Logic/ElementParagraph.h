...
namespace NSDocxRenderer
{
	...
	template<typename T> 
	void SortElements(CSimpleArray<T*>& oArray)
	{
	...
	public:
		...
		inline void Write(NSDocxRenderer::CStringWriter& oWriter, CFontManagerLight* pManagerLight, bool bIsAddSpace = false)
		{
		...
		inline void WriteTo(double dSpacingMM, NSDocxRenderer::CStringWriter& oWriter, CFontManagerLight* pManagerLight)
		{
			oWriter.WriteString(g_bstr_text_run_Start);
