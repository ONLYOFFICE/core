...
namespace NSDocxRenderer
{
	...
	public:
		...
		void WriteFormatStringV( const wchar_t* szFormat, va_list args )
		{
			ATL::CStringW str;
			str.FormatV( szFormat, args );
			WriteString( str.GetBuffer(), str.GetLength() );
		}

		void WriteFormatString( const wchar_t* szFormat, ... )
		{
			va_list argList;
			va_start( argList, szFormat );
			WriteFormatStringV( szFormat, argList );
			va_end( argList );
		}
