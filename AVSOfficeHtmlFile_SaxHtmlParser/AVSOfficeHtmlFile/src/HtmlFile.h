...
private:
	...
	bool HtmlToXHtml_htmlayout( const wchar_t * html_path, const wchar_t * xhtml_path, const MhtFile* mhtFile, BOOL bDownloadImages, int nDefaultCodePage = CP_ACP);
...
private:
	...
	int getSize(MSXML2::IXMLDOMNamedNodeMapPtr attributs, LPCWSTR nameSize);
	...
	const int getDefaultCodePageFromOptions(BSTR sXMLOptions);
