...
{
	void Converter::TableConvert(const Odt::Content::Table& pTable, CSlide& pEContainer, const Odt::Logic::Properties& ParentProps, long x, long y, bool master)const
	{
		long xt = x;
		long yt = y;
	...
	void Converter::TableCellConvert(const Odt::Content::TableCell& pTableCell, CSlide& pEContainer, const Odt::Logic::Properties& ParentProps, long x, long y, long w, long h, bool master)const
	{
