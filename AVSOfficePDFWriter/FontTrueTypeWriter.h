...
typedef void (*FontFileOutputFunc)(Stream pStream, char *sData, int nLen);
...
public:
	...
	// таблицу 'cmap'.
	void WriteTTF(FontFileOutputFunc pOutputFunc, Stream pOutputStream, char *sName = NULL, unsigned short *pCodeToGID = NULL, unsigned char *pUseGlyfs = NULL, long lGlyfsCount = 0) 
	{
	...
	void WriteOTF(FontFileOutputFunc pOutputFunc, Stream pOutputStream, char *sName = NULL, unsigned short *pCodeToGID = NULL) 
	{
