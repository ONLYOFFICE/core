...
{
	void Converter::TimingConvert(const DWORD SldNum, const PPTX::Logic::Timing& pTiming, NSPresentationEditor::CDocument& pDocument)
	{
	...
	void Converter::TimeNodeListConvert(const PPTX::Logic::TnLst& tnLst, NSPresentationEditor::CAnimationInfo& tnContainer)
	{
	...
	void Converter::TimeNodeBaseConvert(const PPTX::Logic::TimeNodeBase& timeNode, NSPresentationEditor::CAnimationInfo& tnContainer)
	{
	...
	void Converter::CBhvr2TimeBehaviorContainer(const PPTX::Logic::CBhvr& bhvr, NSPresentationEditor::CAnimationInfo& container)
	{
...
//			container.m_oClientVisualElement.m_oVisualPageAtom.m_Type = Animations::TL_TVET_Page;
	...
	void Converter::CTN2TimeNodeAtom(const PPTX::Logic::CTn& cTn, NSPresentationEditor::CAnimationInfo& container)
	{
...
//			AddCondLst(cTn.stCondLst.get(), container);
	...
	void Converter::AddCondLst(const PPTX::Logic::CondLst& condLst, NSPresentationEditor::CAnimationInfo& container)
	{
...
//		}
	...
	int Converter::ParseTLTime(const CString& str)
	{
