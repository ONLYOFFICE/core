...
#include "RtfProperty.h"
	...
	{
	public: OOXColorReader2( )
			{
			}
	public: bool Parse( ReaderParameter oParam, RtfColor& oOutputColor,CString sColor, CString sTheme,CString sThemeShade, CString sThemeTint )
			{	
				...
				if( TRUE == oXmlReader.OpenFromXmlNode( oParam.oNode ) )
				{
					...
					if( _T("") != sThemeColor )
					{
						...
						if( true == oParam.oDocument->m_oColorTable.GetColor( oTheme , oOutputColor ) )
						{
							//из themeColor
