...
%%DocumentNeededResources: CMap (Hojo-EUC-H)
%%IncludeResource: ProcSet (CIDInit)
%%IncludeResource: CMap (Hojo-EUC-H)
%%BeginResource: CMap (Hojo-EUC-V)
%%Title: (Hojo-EUC-V Adobe Japan2 0)
%%Version: 9.001
%%Copyright: -----------------------------------------------------------
