...
%%DocumentNeededResources: CMap (UniHojo-UCS2-H)
%%IncludeResource: ProcSet (CIDInit)
%%IncludeResource: CMap (UniHojo-UCS2-H)
%%BeginResource: CMap (UniHojo-UCS2-V)
%%Title: (UniHojo-UCS2-V Adobe Japan2 0)
%%Version: 9.001
%%Copyright: -----------------------------------------------------------
