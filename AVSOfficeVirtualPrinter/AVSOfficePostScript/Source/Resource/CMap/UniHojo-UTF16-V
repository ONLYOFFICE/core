...
%%DocumentNeededResources: CMap (UniHojo-UTF16-H)
%%IncludeResource: ProcSet (CIDInit)
%%IncludeResource: CMap (UniHojo-UTF16-H)
%%BeginResource: CMap (UniHojo-UTF16-V)
%%Title: (UniHojo-UTF16-V Adobe Japan2 0)
%%Version: 1.000
%%Copyright: -----------------------------------------------------------
