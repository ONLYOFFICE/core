========================================================================
    ACTIVE TEMPLATE LIBRARY : AVSOfficeSpool Project Overview
========================================================================

AppWizard has created this AVSOfficeSpool project for you to use as the starting point for
...
_AVSOfficeSpool.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_AVSOfficeSpool.h)
        GUID definitions                                (_AVSOfficeSpool_i.c)
        A type library                                  (_AVSOfficeSpool.tlb)
        Marshaling code                                 (_AVSOfficeSpool_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named AVSOfficeSpool.pch and a precompiled types file named StdAfx.obj.
...
AVSOfficeSpoolps.vcproj
	...
	dlldata.c, AVSOfficeSpool_i.c and AVSOfficeSpool_p.c which are required
	to build the proxy/stub DLL.

AVSOfficeSpoolps.def
