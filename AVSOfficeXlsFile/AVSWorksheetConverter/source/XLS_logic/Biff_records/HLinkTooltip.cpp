...
#include <XLS_logic/Biff_structures/FrtRefHeaderNoGrbit.h>
...
void HLinkTooltip::writeFields(CFRecord& record)
{
	...
	std::wstring wzTooltip_prep(static_cast<wchar_t*>(static_cast<_bstr_t>(wzTooltip)));
...
void HLinkTooltip::readFields(CFRecord& record)
{
	...
	record >> wzTooltip_prep;
	wzTooltip = _bstr_t(wzTooltip_prep.c_str());
}
