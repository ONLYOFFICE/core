...
void CellOffsetResender::toXML(MSXML2::IXMLDOMElementPtr parent)
{
}
...
void CellOffsetResender::resend(CFStream& stream, const DWORD data_place, const DWORD data)
{
	DWORD CELL_start_pos = data_place - sizeof(WORD)/*size_short*/ - sizeof(CFRecordType::TypeId);
