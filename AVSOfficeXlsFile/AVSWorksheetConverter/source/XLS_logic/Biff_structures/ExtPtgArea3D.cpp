...
void ExtPtgArea3D::toXML(MSXML2::IXMLDOMElementPtr parent)
{
...
const bool ExtPtgArea3D::fromXML(MSXML2::IXMLDOMElementPtr parent)
{
...
void ExtPtgArea3D::assemble(AssemblerStack& ptg_stack, PtgQueue& extra_data, MSXML2::IXMLDOMElementPtr parent)
{
