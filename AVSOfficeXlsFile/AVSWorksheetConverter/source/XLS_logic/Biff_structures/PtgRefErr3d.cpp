...
PtgRefErr3d::PtgRefErr3d(const WORD ixti_init, const PtgDataType data_type)
...
void PtgRefErr3d::assemble(AssemblerStack& ptg_stack, PtgQueue& extra_data, MSXML2::IXMLDOMElementPtr parent)
{
