...
public:
	...
	static const bool extract_PtgName(std::wstring::const_iterator& first, std::wstring::const_iterator last, DWORD& out_num, MSXML2::IXMLDOMElementPtr parent);
	...
	static const bool extract_3D_part(std::wstring::const_iterator& first, std::wstring::const_iterator last, WORD& ixti, MSXML2::IXMLDOMElementPtr parent);
