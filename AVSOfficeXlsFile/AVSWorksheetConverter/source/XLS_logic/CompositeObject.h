...
public:
	...
	virtual const bool read(CFStreamCacheReader& reader, MSXML2::IXMLDOMElementPtr parent, const bool mandatory); // Read self and children
...
public:
	...
	virtual const bool read(CFStreamCacheReader& reader, MSXML2::IXMLDOMElementPtr parent, const bool is_mandatory);
	virtual const bool write(BinWriterProcessor& proc, const bool is_mandatory);

private:
	virtual MSXML2::IXMLDOMElementPtr makeXMLNode() { return NULL;};
};
