...
core_windows {
	...
	LIBS += \
		...
		-L$$PWD/aom/build/$$HEIF_BUILDS_PLATFORM_PREFIX/$$CORE_BUILDS_CONFIGURATION_PREFIX/$$BUILD_TYPE -laom \
...
core_linux | core_android {
	...
	LIBS += \
		...
		-L$$PWD/aom/build/$$HEIF_BUILDS_PLATFORM_PREFIX/$$CORE_BUILDS_CONFIGURATION_PREFIX -laom \
		-Wl,--no-whole-archive \
