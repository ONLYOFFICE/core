...
//        }
    ...
    std::wstring CCompiledStyle::GetStyleW() const
    {
        ...
        return std::accumulate(m_mStyle.begin(), m_mStyle.end(), sStyle,
            [] (std::wstring& sRes, const std::pair<class std::basic_string<wchar_t,struct std::char_traits<wchar_t>,class std::allocator<wchar_t> > const ,class std::basic_string<wchar_t,struct std::char_traits<wchar_t>,class std::allocator<wchar_t>>>& oIter)
               { return sRes + oIter.first + L":" + oIter.second + L";"; });
    }
