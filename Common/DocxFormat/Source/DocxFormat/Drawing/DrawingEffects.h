...
namespace OOX
{
	namespace Drawing
	{
        ...
        //-----------------------------------------------------------------------
        // CEffectContainer 20.1.8.20;20.1.8.25
        //-----------------------------------------------------------------------
...
// Effects & Fills elements & Line Properties
namespace OOX
{
	namespace Drawing
	{
        //-----------------------------------------------------------------------
        // AlphaBiLevelEffect 20.1.8.1
        //-----------------------------------------------------------------------
        ...
        //-----------------------------------------------------------------------
        // AlphaModulateFixedEffect 20.1.8.6
        //-----------------------------------------------------------------------
		...
		public:
            ...
            virtual std::wstring      toXML() const
			{
                std::wstring sResult = _T("<a:clrTo>");
		...
		public:
            ...
            virtual std::wstring toXML() const
			{
                ...
                std::wstring sResult = _T("<a:duotone>");
		...
		//-----------------------------------------------------------------------
        // RelativeRect 20.1.8.30;20.1.8.31;20.1.8.55;20.1.8.59
        //-----------------------------------------------------------------------				
        ...
        //-----------------------------------------------------------------------
        // CGradientFillProperties 20.1.8.33
        //-----------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------
        // LineEndProperties 20.1.8.38;20.1.8.57
        //-----------------------------------------------------------------------				
		...
		//-----------------------------------------------------------------------
        // LinearShadeProperties 20.1.8.41
        //-----------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------
        // LineJoinMiterProperties 20.1.8.43
        //-----------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------
        // PatternFillProperties 20.1.8.47
        //-----------------------------------------------------------------------				
		...
		//-----------------------------------------------------------------------
        // PresetLineDashProperties 20.1.8.48
        //-----------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------
        // RelativeOffsetEffect 20.1.8.51
        //-----------------------------------------------------------------------				
        ...
        //-----------------------------------------------------------------------
        // SolidColorFillProperties 20.1.8.54
        //-----------------------------------------------------------------------				
		...
		public:
            ...
            virtual std::wstring      toXML() const
			{
                std::wstring sResult = _T("<a:solidFill>");
		...
		//-----------------------------------------------------------------------
        // StretchInfoProperties 20.1.8.56
        //-----------------------------------------------------------------------				
