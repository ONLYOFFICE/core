...
namespace XLSB
{
    ...
    BaseObjectPtr BeginSXTDMP::clone()
    {
        return BaseObjectPtr(new BeginSXTDMP(*this));
    }

    void BeginSXTDMP::readFields(XLS::CFRecord& record)
    {
        _UINT16 flags;
