...
namespace XLSB
{
    // Logical representation of BrtListTrFmla record in BIFF12
    class ListTrFmla: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(ListTrFmla)
            BASE_OBJECT_DEFINE_CLASS_NAME(ListTrFmla)
        public:
            ListTrFmla();
            ~ListTrFmla();
