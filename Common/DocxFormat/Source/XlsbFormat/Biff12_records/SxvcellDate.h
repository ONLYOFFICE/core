...
namespace XLSB
{
    // Logical representation of BrtSxvcellDate record in BIFF12
    class SxvcellDate: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(SxvcellDate)
            BASE_OBJECT_DEFINE_CLASS_NAME(SxvcellDate)
        public:
            SxvcellDate();
            ~SxvcellDate();
