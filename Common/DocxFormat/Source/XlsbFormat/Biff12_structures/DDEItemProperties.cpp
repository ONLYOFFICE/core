...
namespace XLSB
{
    ...
    DDEItemProperties::DDEItemProperties(XLS::CFRecord& record)
    {
        load(record);
    }
    ...
    BiffStructurePtr DDEItemProperties::clone()
    {
        return BiffStructurePtr(new DDEItemProperties(*this));
    }

    void DDEItemProperties::load(XLS::CFRecord& record)
    {
        _UINT16 flags;
