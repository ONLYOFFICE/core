...
#include "../Biff12_records/SXDI14.h"
#include "../Biff12_records/SXDI15.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr FRTSXDI::clone()
    {
        return BaseObjectPtr(new FRTSXDI(*this));
    }
    ...
    const bool FRTSXDI::loadContent(BinProcessor& proc)
    {
        ...
        if (proc.optional<SXDI14>())
        {
            m_BrtSXDI14 = elements_.back();
            elements_.pop_back();
        }
        ...
        if (proc.optional<SXDI15>())
        {
            m_BrtSXDI15 = elements_.back();
            elements_.pop_back();
        }
