...
#include "../Biff12_unions/PIVOTFILTERS.h"
...
namespace XLSB
{
    ...
    PIVOTFILTERCOLUMN::PIVOTFILTERCOLUMN()
    {
    }
    ...
    BaseObjectPtr PIVOTFILTERCOLUMN::clone()
    {
        return BaseObjectPtr(new PIVOTFILTERCOLUMN(*this));
    }

    // PIVOTFILTERCOLUMN = BrtBeginFilterColumn (BrtDynamicFilter / BrtTop10Filter / CUSTOMFILTERS / PIVOTFILTERS) *FRT
    const bool PIVOTFILTERCOLUMN::loadContent(BinProcessor& proc)
    {
