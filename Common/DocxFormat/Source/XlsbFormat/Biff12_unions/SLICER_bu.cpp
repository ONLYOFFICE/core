...
#include "../Biff12_records/BeginSlicer.h"
#include "../Biff12_unions/FRT.h"
#include "../Biff12_records/EndSlicer.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr SLICER::clone()
    {
        return BaseObjectPtr(new SLICER(*this));
    }

    //SLICER = [ACUID] BrtBeginSlicer *FRT BrtEndSlicer
    const bool SLICER::loadContent(BinProcessor& proc)
    {
        ...
        if (proc.optional<BeginSlicer>())
        {
            m_BrtBeginSlicer = elements_.back();
            elements_.pop_back();
        }
