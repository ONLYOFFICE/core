...
namespace NSAttributes
{
	/*static CString ConvertToUtf8(CString str)
	{
		...
		oWriter.SetXmlString(str);
		return oWriter.EncodingASCIIToUTF8();
	}*/
	...
	public:
        ...
        CString ToString()
        {
			...
			return AddEffectForGroup(_T("ImagePaint-SetBrush"), 
				...
				+ _T("' texturemode='") + NSAttributes::ToString(m_nTextureMode)//  + _T("'")); 
				//+ _T("' rectable='") + BoolToString(m_bApplyBounds) + _T("' rect-left='") + NSAttributes::ToString(m_rcBounds.left)
				//+ _T("' rect-top='") + NSAttributes::ToString(m_rcBounds.top)
    			//+ _T("' rect-right='") + NSAttributes::ToString(m_rcBounds.right) + _T("' rect-bottom='") + NSAttributes::ToString(m_rcBounds.bottom)
			...
			/*return AddEffectForGroup(_T("ImagePaint-SetBrush"), 
				...
				+ _T("' color1='") + m_oColor1.ToString() + _T("' color2='") + m_oColor2.ToString()
				+ _T("' alpha1='") + NSAttributes::ToString(m_Alpha1) + _T("' alpha2='") + NSAttributes::ToString(m_Alpha2) 
                + _T("' texturepath='") + StreamUtils::ConvertCStringWToCString(m_sTexturePath) + _T("' texturealpha='") + NSAttributes::ToString(m_nTextureAlpha)  
		...
		CString ToString2()
        {
			...
			return AddEffectForGroup(_T("brush"), 
				...
				+ _T("' brush-texturemode='") + NSAttributes::ToString(m_nTextureMode)//  + _T("'")); 
				//+ _T("' rectable='") + BoolToString(m_bApplyBounds) + _T("' rect-left='") + NSAttributes::ToString(m_rcBounds.left)
				//+ _T("' rect-top='") + NSAttributes::ToString(m_rcBounds.top)
				//+ _T("' rect-right='") + NSAttributes::ToString(m_rcBounds.right) + _T("' rect-bottom='") + NSAttributes::ToString(m_rcBounds.bottom)
				+ _T("' linearangle='") + NSAttributes::ToString(m_fAngle)
            ...
            /*return AddEffectForGroup(_T("brush"), 
				...
				+ _T("' brush-color1='") + m_oColor1.ToString() + _T("' brush-color2='") + m_oColor2.ToString()
				+ _T("' brush-alpha1='") + NSAttributes::ToString(m_Alpha1) + _T("' brush-alpha2='") + NSAttributes::ToString(m_Alpha2) 
				+ _T("' brush-texturepath='") + StreamUtils::ConvertCStringWToCString(m_sTexturePath) + _T("' brush-texturealpha='") + NSAttributes::ToString(m_nTextureAlpha)  
