...
public:
	...
	{
		m_eRuler = eType;
//		m_nCountPoints = GetCountPoints(m_eRuler);
	...
	//CString ToXmlPPT(CGeomShapeInfo& pGeomInfo, long w, long h)
	//{
	//	CString strRes = GetRulerName(m_eRuler);
