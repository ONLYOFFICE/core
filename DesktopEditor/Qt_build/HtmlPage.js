...
function CEditorPage(api)
{
    ...
    this.checkBodySize = function()
    {
        ...
        if (this.Width != _newW || this.Height != _newH)
        {
			...
			if (window["NativeEditorObj"])
			{
				window["NativeEditorObj"]["native_OnResize"](this.X, this.Y, this.Width, this.Height);
			}
    ...
    this.Init = function()
    {
		...
		var _el_viewport = document.getElementById("viewport");
		var _el_viewport_l_menu = document.getElementById("left-menu");
		var _el_viewport_r_menu = document.getElementById("right-menu");

		var _color = window.getComputedStyle(_el_viewport, null).backgroundColor;
		_el_viewport.style.backgroundColor = "transparent";
		_el_viewport_l_menu.style.backgroundColor = _color;
		_el_viewport_r_menu.style.backgroundColor = _color;
    ...
    this.initEvents2 = function()
    {
        ...
        this.m_oBody.HtmlElement.onmousedown  = this.onMouseDownNative;
        this.m_oBody.HtmlElement.onmousemove  = this.onMouseMoveNative;
        this.m_oBody.HtmlElement.onmouseup    = this.onMouseUpNative;
        ...
        */
        window.onkeydown = this.onKeyDownNative;
        window.onkeypress = this.onKeyPressNative;
        window.onkeyup = this.onKeyUpNative;
    ...
    this.onMouseDownNative = function(e)
    {
        if (false == oThis.m_oApi.bInit_word_control || !window["NativeEditorObj"])
            return;
        ...
        window["NativeEditorObj"]["native_OnMouse"](0, global_mouseEvent.X, global_mouseEvent.Y, _flags);
    }

    this.onMouseMoveNative = function(e)
    {
        if (false == oThis.m_oApi.bInit_word_control || !window["NativeEditorObj"])
            return;
        ...
        window["NativeEditorObj"]["native_OnMouse"](1, global_mouseEvent.X, global_mouseEvent.Y, _flags);
    }

    this.onMouseUpNative = function(e)
    {
        if (false == oThis.m_oApi.bInit_word_control || !window["NativeEditorObj"])
            return;
        ...
        window["NativeEditorObj"]["native_OnMouse"](2, global_mouseEvent.X, global_mouseEvent.Y, _flags);
    }

    this.onKeyDownNative = function(e)
    {
        if (oThis.IsFocus === false || !window["NativeEditorObj"])
            return;
        ...
        window["NativeEditorObj"]["native_OnKeyboard"](0, global_keyboardEvent.KeyCode, global_keyboardEvent.CharCode, _flags);
    }

    this.onKeyPressNative = function(e)
    {
        if (oThis.IsFocus === false || !window["NativeEditorObj"])
            return;
        ...
        window["NativeEditorObj"]["native_OnKeyboard"](1, global_keyboardEvent.KeyCode, global_keyboardEvent.CharCode, _flags);
    }

    this.onKeyUpNative = function(e)
    {
        ...
        if (window["NativeEditorObj"])
        {
             window["NativeEditorObj"]["native_OnKeyboard"](2, global_keyboardEvent.KeyCode, global_keyboardEvent.CharCode, 0);
        }
    }
