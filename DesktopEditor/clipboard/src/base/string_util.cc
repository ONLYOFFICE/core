...
const std::string EmptyString() {
	return std::string();//EmptyStrings::GetInstance()->s;
}

const std::wstring EmptyWString() {
	return std::wstring();//EmptyStrings::GetInstance()->ws;
}

const string16 EmptyString16() {
  return string16();//EmptyStrings::GetInstance()->s16;
}
...
/*
inline static size_t find_first_of(std::string &sStr, char _Ch, std::string::size_type _Off = 0)
{	// look for _Ch at or after _Off
	return sStr.find_first_of(_Ch, _Off);
}

inline static size_t find_first_of(std::wstring &sStr, wchar_t _Ch, std::wstring::size_type _Off = 0)
{	// look for _Ch at or after _Off
	return sStr.find_first_of(_Ch, _Off);
}
*/
