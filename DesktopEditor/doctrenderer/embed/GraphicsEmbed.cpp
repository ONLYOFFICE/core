...
JSSmart<CJSValue> CGraphicsEmbed::init(JSSmart<CJSValue> ImagesDirectory, JSSmart<CJSValue> FontsDirectory, JSSmart<CJSValue> width_px, JSSmart<CJSValue> height_px, JSSmart<CJSValue> width_mm, JSSmart<CJSValue> height_mm)
{
    m_pInternal->init(ImagesDirectory->toStringW(), FontsDirectory->toStringW(), width_px->toDouble(), height_px->toDouble(), width_mm->toDouble(), height_mm->toDouble());
    return NULL;
}
