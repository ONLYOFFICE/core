...
#define CURRENTWRAPPER CGraphicsEmbed
	...
	FUNCTION_WRAPPER_V8_0(_Start_GlobalAlpha, Start_GlobalAlpha)
	FUNCTION_WRAPPER_V8_0(_End_GlobalAlpha, End_GlobalAlpha)
	...
	FUNCTION_WRAPPER_V8_0(__s, _s)
	FUNCTION_WRAPPER_V8_0(__e, _e)
	FUNCTION_WRAPPER_V8_0(__z, _z)
	FUNCTION_WRAPPER_V8_2(__m, _m)
	FUNCTION_WRAPPER_V8_2(__l, _l)
	FUNCTION_WRAPPER_V8_6(__c, _c)
	FUNCTION_WRAPPER_V8_4(__c2, _c2)
	FUNCTION_WRAPPER_V8_0(_ds, ds)
	FUNCTION_WRAPPER_V8_0(_df, df)
	FUNCTION_WRAPPER_V8_0(_save, save)
	FUNCTION_WRAPPER_V8_0(_restore, restore)
	FUNCTION_WRAPPER_V8_0(_clip, clip)
	FUNCTION_WRAPPER_V8_0(_reset, reset)
	FUNCTION_WRAPPER_V8_0(_FreeFont, FreeFont)
	FUNCTION_WRAPPER_V8_0(_ClearLastFont, ClearLastFont)
	FUNCTION_WRAPPER_V8_7(_drawImage2, drawImage2)
	FUNCTION_WRAPPER_V8_8(_drawImage, drawImage)
	FUNCTION_WRAPPER_V8_0(_GetFont, GetFont)
	FUNCTION_WRAPPER_V8_2(_font, font)
	FUNCTION_WRAPPER_V8_4(_SetFont, SetFont)
	FUNCTION_WRAPPER_V8_0(_GetTextPr, GetTextPr)
	...
	FUNCTION_WRAPPER_V8_0(_GetIntegerGrid, GetIntegerGrid)
	...
	FUNCTION_WRAPPER_V8_0(_RemoveClipRect, RemoveClipRect)
	FUNCTION_WRAPPER_V8_4(_SetClip, SetClip)
	FUNCTION_WRAPPER_V8_0(_RemoveClip, RemoveClip)
	...
	FUNCTION_WRAPPER_V8_0(_SavePen, SavePen)
	FUNCTION_WRAPPER_V8_0(_RestorePen, RestorePen)
	FUNCTION_WRAPPER_V8_0(_SaveBrush, SaveBrush)
	FUNCTION_WRAPPER_V8_0(_RestoreBrush, RestoreBrush)
	FUNCTION_WRAPPER_V8_0(_SavePenBrush, SavePenBrush)
	FUNCTION_WRAPPER_V8_0(_RestorePenBrush, RestorePenBrush)
	FUNCTION_WRAPPER_V8_0(_SaveGrState, SaveGrState)
	FUNCTION_WRAPPER_V8_0(_RestoreGrState, RestoreGrState)
	FUNCTION_WRAPPER_V8_0(_StartClipPath, StartClipPath)
	FUNCTION_WRAPPER_V8_0(_EndClipPath, EndClipPath)
	FUNCTION_WRAPPER_V8_0(_StartCheckTableDraw, StartCheckTableDraw)
	...
	FUNCTION_WRAPPER_V8_0(_UncheckUseFonts2, UncheckUseFonts2)
	FUNCTION_WRAPPER_V8_4(_Drawing_StartCheckBounds, Drawing_StartCheckBounds)
	FUNCTION_WRAPPER_V8_0(_Drawing_EndCheckBounds, Drawing_EndCheckBounds)
	...
	FUNCTION_WRAPPER_V8_0(_GetPenColor, GetPenColor)
	FUNCTION_WRAPPER_V8_0(_GetBrushColor, GetBrushColor)
	...
	FUNCTION_WRAPPER_V8_0(_get_LineJoin, get_LineJoin)
	FUNCTION_WRAPPER_V8_4(_put_TextureBounds, put_TextureBounds)
	FUNCTION_WRAPPER_V8_0(_GetlineWidth, GetlineWidth)
...
class CGraphicsEmbedAdapter : public CJSEmbedObjectAdapterV8Template
{
public:
	virtual v8::Local<v8::ObjectTemplate> getTemplate(v8::Isolate* isolate) override
	{
		v8::EscapableHandleScope handle_scope(isolate);
		v8::Local<v8::ObjectTemplate> templ = NSGraphicsEmbed::CreateTemplate(isolate);
