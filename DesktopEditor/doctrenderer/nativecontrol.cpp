...
void _GetFilePath(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    v8::MaybeLocal<v8::String> stringOut = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(),sReturn.c_str());
    args.GetReturnValue().Set(CV8Convert::unwrap<v8::String>(stringOut));
}
...
void _GetChangesFile(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    v8::MaybeLocal<v8::String> stringOut = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(),strFile.c_str());
    args.GetReturnValue().Set(CV8Convert::unwrap<v8::String>(stringOut));
}
...
void _GetFileString(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    v8::MaybeLocal<v8::String> stringOut = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), (char*)pData, v8::NewStringType::kNormal, len);
    args.GetReturnValue().Set(CV8Convert::unwrap<v8::String>(stringOut));
}
...
void _zipOpenFile(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    for (std::vector<std::wstring>::iterator i = pNative->m_oZipWorker.m_arFiles.begin(); i != pNative->m_oZipWorker.m_arFiles.end(); i++)
    {
        ...
        v8::MaybeLocal<v8::String> _maybe_k = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), sFile.c_str(), v8::NewStringType::kNormal, -1);
        v8::MaybeLocal<v8::String> _maybe_v = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), sFile.c_str(), v8::NewStringType::kNormal, -1);

        obj->Set(v8::Isolate::GetCurrent()->GetCurrentContext(), CV8Convert::unwrap<v8::String>(_maybe_k), CV8Convert::unwrap<v8::String>(_maybe_v));
    }
...
void _GetImageUrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    v8::MaybeLocal<v8::String> stringOut = v8::String::NewFromUtf8(v8::Isolate::GetCurrent(), (char*)sRetA.c_str(), v8::NewStringType::kNormal, (int)sRetA.length());
    args.GetReturnValue().Set(CV8Convert::unwrap<v8::String>(stringOut));
}
