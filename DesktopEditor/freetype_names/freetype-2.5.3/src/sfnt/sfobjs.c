...
#define FT_COMPONENT  trace_sfobjs
  ...
  static wchar_t*
  tt_name_entry_ascii_from_utf16_2( TT_NameEntry  entry,
                                  FT_Memory     memory )
  {
    wchar_t*  string = NULL;
    FT_UInt     len, code, n;
  ...
  static wchar_t*
  tt_name_entry_ascii_from_other_2( TT_NameEntry  entry,
                                  FT_Memory     memory )
  {
    wchar_t*  string = NULL;
    FT_UInt     len, code, n;
  ...
  static FT_Error
  tt_face_get_name2( TT_Face      face, FT_Int found_apple, FT_Int found_apple_roman, FT_Int found_apple_english, FT_Int found_win, FT_Int found_unicode, FT_Bool is_english )
  {
    ...
    if ( found_win >= 0/* && !( found_apple >= 0 && !is_english ) */)
    {
      ...
      case TT_MS_ID_SYMBOL_CS:
        convert = tt_name_entry_ascii_from_utf16_2;
        break;
    ...
    else if ( found_apple >= 0 )
    {
      ...
      convert = tt_name_entry_ascii_from_other_2;
    }
  ...
  Exit:
    if (NULL != result)
	{
		if (face->utf16_len == 0)
		{
			face->utf16_names = (wchar_t**)malloc(1 * sizeof(wchar_t*));
			face->utf16_names[0] = result;
			face->utf16_len = 1;
		}
		else
		{
			wchar_t** old = face->utf16_names;
			face->utf16_names = (wchar_t**)malloc((face->utf16_len + 1) * sizeof(wchar_t*));
			memcpy(face->utf16_names, old, face->utf16_len * sizeof(wchar_t*));
			face->utf16_names[face->utf16_len] = result;
			face->utf16_len += 1;
		}
	}
    ...
    for ( n = 0; n < face->num_names; n++, rec++ )
    {
      ...
      if ( rec->nameID == nameid && rec->stringLength > 0 )
      {
        ...
        case TT_PLATFORM_ISO:
		  ...
		  if (1 == nameid || 21 == nameid || 16 == nameid)
			tt_face_get_name2(face, -1, -1, -1, -1, found_unicode, 0);
        ...
        case TT_PLATFORM_MACINTOSH:
          ...
          if ( rec->languageID == TT_MAC_LANGID_ENGLISH )
		  {
			  ...
			  if (1 == nameid || 21 == nameid || 16 == nameid)
				  tt_face_get_name2(face, -1, -1, found_apple_english, -1, -1, 0);
		  }
          else if ( rec->encodingID == TT_MAC_ID_ROMAN )
		  {
			  found_apple_roman = n;
			  if (1 == nameid || 21 == nameid || 16 == nameid)
				  tt_face_get_name2(face, -1, found_apple_roman, -1, -1, -1, 0);
		  }
          break;
        ...
        case TT_PLATFORM_MICROSOFT:
          ...
          if ( found_win == -1 || ( rec->languageID & 0x3FF ) == 0x009 )
          {
            ...
            case TT_MS_ID_UCS_4:
			  ...
			  if (1 == nameid || 21 == nameid || 16 == nameid)
				  tt_face_get_name2(face, -1, -1, -1, found_win, -1, is_english);
              break;
		  ...
		  else
		  {
            ...
            case TT_MS_ID_UCS_4:
			  ...
			  if (1 == nameid || 21 == nameid || 16 == nameid)
				  tt_face_get_name2(face, -1, -1, -1, n, -1, FT_BOOL( ( rec->languageID & 0x3FF ) == 0x009 ));
              break;
