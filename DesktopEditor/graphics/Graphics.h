...
// –ассто€ние от центра до контрольных точек Ѕезье дл€ аппроксимации окружности = (4 * (sqrt(2) - 1) / 3) * r
static const double c_dKappa   = ((double)0.55228475);
static const double c_dKappa_2 = ((double)(0.5 * 0.55228475));

// ƒелим 16-битное значение [0, 255*255] на 255, возвращаем 8-битное значение.
...
protected:
	...
	// дл€ отрисовки картинок - используем Gdiplus
