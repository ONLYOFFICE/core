...
(function(window, undefined) {
    ...
    {
		this.djvu = arrayBuffer.length > 7 && 0x41 == arrayBuffer[0] && 0x54 == arrayBuffer[1] && 0x26 == arrayBuffer[2] && 0x54 == arrayBuffer[3] && 0x46 == arrayBuffer[4] && 0x4f == arrayBuffer[5] && 0x52 == arrayBuffer[6] && 0x4d == arrayBuffer[7];
    ...
    CFile.prototype.getInfo = function()
    {
        ...
        var _info = Module["_GFD_GetInfo"](this.nativeFile);
        if (!_info)
            return false;
    ...
    {
        var res = Module["_GFD_GetPixmap"](this.nativeFile, pageIndex, width, height);
		if (!this.djvu)
		{
    ...
    {
        Module["_GFD_Close"](this.nativeFile);
        this.nativeFile = 0;
        this.pages = [];
    };
