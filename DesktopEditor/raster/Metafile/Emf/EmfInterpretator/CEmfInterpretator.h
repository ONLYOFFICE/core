...
namespace MetaFile
{
	...
	private:
		...
		void WriteRectangle (const TRectL&              oBounds);
		void WriteRectangle (const TEmfPlusRect&        oRect);
		void WriteRectangle (const TEmfPlusRectF&       oRect);
		void WriteSize      (const TSizeL&              oSize);
		void WriteColor     (const TRGBA&               oColor);
		...
		void WritePoint     (const TPointL&             oPoint);
		void WritePoint     (const TPointS&             oPoint);
