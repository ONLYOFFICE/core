...
namespace MetaFile
{
        ...
        void CEmfInterpretatorXml::HANDLE_EMR_HEADER(const TEmfHeader &oTEmfHeader, CDataStream &oDataStream,
        ...
        void CEmfInterpretatorXml::HANDLE_EMR_EXTTEXTOUTA(const TEmfExtTextoutA &oTEmfExtTextoutA, const unsigned int &unRecordSize)
        {
                m_pOutputXml->WriteNode(L"EMR_EXTTEXTOUTA", oTEmfExtTextoutA, {XmlArgument(L"Id", EMR_EXTTEXTOUTA),
                                                                               XmlArgument(L"Size", unRecordSize + 8)});
        }

        void CEmfInterpretatorXml::HANDLE_EMR_EXTTEXTOUTW(const TEmfExtTextoutW &oTEmfExtTextoutW, const unsigned int &unRecordSize)
        {
        ...
        void CEmfInterpretatorXml::HANDLE_EMR_SMALLTEXTOUT(const TEmfSmallTextout &oText, const unsigned int& unRecordSize)
        {
