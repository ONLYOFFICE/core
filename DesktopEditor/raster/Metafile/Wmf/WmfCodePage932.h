#ifndef _WMF_CODE_PAGE_932_H
#define _WMF_CODE_PAGE_932_H
...
struct TMSCP932_Pair
{
	unsigned short ushCode;
	unsigned short ushUnicode;
};

static const TMSCP932_Pair c_aoUnicodeMapCP932WithLeadByte[] =
{
...
static unsigned short CP932_Find(unsigned short ushCode)
{
	TMSCP932_Pair *pPair = (TMSCP932_Pair *)c_aoUnicodeMapCP932WithLeadByte;
...
static std::wstring CP932_CharToUnicode(const char *sString)
{
	...
	for (int nIndex = 0; nIndex < nLen; nIndex++)
	{
		...
		unsigned short ushUnicode = c_anUnicodeMapCP932[unCode];

		if (-1 == nLeadByte)
		{
			if (MSCP932_LEAD_CHAR != ushUnicode)
			{
		...
		else
		{
			...
			wsString[nIndex] = CP932_Find(ushCode);
		}
	}
