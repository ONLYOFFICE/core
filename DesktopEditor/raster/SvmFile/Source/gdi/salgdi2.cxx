							  ...
							  SalColor nTransparentColor )
{
	...
	const SVMCore::Point aPoint;
	const SVMCore::Size	aSize( rSalBitmap.GetSize() );
...
void WinSalGraphics::invert( long nX, long nY, long nWidth, long nHeight, SVMCore::SalInvert nFlags )
{
...
void WinSalGraphics::invert( ULONG nPoints, const SalPoint* pPtAry, SVMCore::SalInvert nSalFlags )
{
	HPEN		hPen;
	HPEN		hOldPen;
	HBRUSH		hBrush;
