...
public:
	...
	// method to take care of PolyFlags
     friend SvStream&    operator>>( SvStream& rIStream, Polygon& rPoly );
     friend SvStream&    operator<<( SvStream& rOStream, const Polygon& rPoly );
...
public:
	...
	sal_Bool			IsEqual( const PolyPolygon& rPolyPoly ) const;
     ...
     friend SvStream&    operator>>( SvStream& rIStream, PolyPolygon& rPolyPoly );
#ifdef AVS
     friend SvStream&    operator<<( SvStream& rOStream, const PolyPolygon& rPolyPoly );
#endif
