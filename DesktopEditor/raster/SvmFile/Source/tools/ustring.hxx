...
#endif
#endif
#include "../tools/rtl_string.hxx"
#include "../tools/ustring.h"
namespace rtl
{
/* ======================================================================= */
...
public:
    ...
    */
    ...
    /**
      ...
      @return   sal_True if the strings are equal;
                sal_False, otherwise.
    */
    sal_Bool equals( const OUString & str ) const 
    {
    ...
    */
    ...
    /**
      ...
      @return   sal_True if str match with the characters in the string
                ...
                sal_False, otherwise.
    */
    sal_Bool match( const OUString & str, sal_Int32 fromIndex = 0 ) const 
    {
    ...
    /**
      ...
      @return   sal_True if str match with the characters in the string
                ...
                sal_False, otherwise.
    */
    sal_Bool matchIgnoreAsciiCase( const OUString & str, sal_Int32 fromIndex = 0 ) const 
    {
    ...
    */
    ...
    /**
      ...
      @return   sal_True if the strings are equal;
                sal_False, otherwise.
    */
    sal_Bool equalsAsciiL( const sal_Char* asciiStr, sal_Int32 asciiStrLength ) const 
    {
    ...
    /**
      ...
      @return   sal_True if the strings are equal;
                sal_False, otherwise.
    */
    sal_Bool equalsIgnoreAsciiCaseAscii( const sal_Char * asciiStr ) const 
    {
    ...
    /**
      ...
      @return   sal_True if the strings are equal;
                sal_False, otherwise.
    */
    sal_Bool equalsIgnoreAsciiCaseAsciiL( const sal_Char * asciiStr, sal_Int32 asciiStrLength ) const 
    {
        if ( pData->length != asciiStrLength )
            return sal_False;
    ...
    /**
      ...
      @return   sal_True if str match with the characters in the string
                ...
                sal_False, otherwise.
    */
    sal_Bool matchAsciiL( const sal_Char* asciiStr, sal_Int32 asciiStrLength, sal_Int32 fromIndex = 0 ) const 
    {
    ...
    /**
      ...
      @return   sal_True if str match with the characters in the string
                ...
                sal_False, otherwise.
    */
    sal_Bool matchIgnoreAsciiCaseAsciiL( const sal_Char* asciiStr, sal_Int32 asciiStrLength, sal_Int32 fromIndex = 0 ) const 
    {
    ...
    */
    OUString copy( sal_Int32 beginIndex ) const 
    {
    ...
    */
    OUString concat( const OUString & str ) const 
    {
        rtl_uString* pNew = 0;
    ...
    */
    OUString replaceAt( sal_Int32 index, sal_Int32 count, const OUString& newStr ) const 
    {
        rtl_uString* pNew = 0;
    ...
    */
    OUString replace( sal_Unicode oldChar, sal_Unicode newChar ) const 
    {
        rtl_uString* pNew = 0;
    ...
    */
    OUString toAsciiLowerCase() const 
    {
        rtl_uString* pNew = 0;
    ...
    */
    OUString toAsciiUpperCase() const 
    {
        rtl_uString* pNew = 0;
