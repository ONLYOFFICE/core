...
// #i80090# GetMirroredChar also needed outside vcl, moved to svapp.hxx
  sal_UCS4 GetMirroredChar( sal_UCS4 );
sal_UCS4 GetLocalizedChar( sal_UCS4, LanguageType );
#ifdef AVS
 const char* GetAutofallback( sal_UCS4 ) ;
#endif
// -------------
// - SalLayout -
// -------------
...
#endif
    SalLayout& operator=( const SalLayout& );
...
class  MultiSalLayout : public SalLayout
{
public:
...
class  GenericSalLayout : public SalLayout
{
public:
    // used by layout engines
