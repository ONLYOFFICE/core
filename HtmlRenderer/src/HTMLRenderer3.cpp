...
namespace NSHtmlRenderer
{
	...
	HRESULT CASCHTMLRenderer3::get_BrushTextureImage(Aggplus::CImage** pImage) { return S_OK; }
	HRESULT CASCHTMLRenderer3::put_BrushTextureImage(Aggplus::CImage* pImage) { return S_OK; }
	HRESULT CASCHTMLRenderer3::get_BrushTransform(Aggplus::CMatrix& oMatrix) { return S_OK; }
	HRESULT CASCHTMLRenderer3::put_BrushTransform(const Aggplus::CMatrix& oMatrix) { return S_OK; }
