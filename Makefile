...
ASCOFFICEUTILSLIB := $(LIBDIR)/libASCOfficeUtilsLib.a
...
ASCOFFICEUTILSLIB_PRO := $(abspath ASCOfficeUtils/ASCOfficeUtilsLib/Linux/ASCOfficeUtilsLib.pro)
...
ALLFONTSGEN_DEP += $(ASCOFFICEUTILSLIB)
