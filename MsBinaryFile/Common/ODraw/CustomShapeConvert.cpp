...
#include "CustomShapeConvert.h"

namespace NSCustomShapesConvert
{
	CSlicePath::CSlicePath(RulesType eType)
	{
		m_eRuler = eType;
	...
	void CFormulaConverter::ConvertCoef(NSCustomShapesConvert::CFormParam pCoef)
	{
	...
	void CFormulaConverter::ConvertCoef2(NSCustomShapesConvert::CFormParam pCoef)
	{
		if (pCoef.m_eType == ptValue)
	...
	void CFormulaConverter::ConvertPath(std::wstring strPath, const CPath& oPath)
	{
		m_arParts.clear();
	...
	void CFormulaConverter::ConvertHandle(const std::vector<CHandle_>& arHandles, std::vector<long>& arAdj, oox::MSOSPT oSType)
	{
	...
	void CFormulaConverter::GetValue(const LONG& lParam, const ParamType& eParamType, const bool& bExtShape, CXmlWriter& oWriter)
	{
	...
	void CFormulaConverter::ConvertVal(const LONG& lParam1, const ParamType& eType1, const bool& bExtShape1, CXmlWriter& oWriter)
	{
		GUIDE_PARAM_1(val)
	}
	...
	void CFormulaConverter::ConvertAbs(const LONG& lParam1, const ParamType& eType1, const bool& bExtShape1, CXmlWriter& oWriter)
	{
		GUIDE_PARAM_1(abs)
	}
	...
	void CFormulaConverter::ConvertSqrt(const LONG& lParam1, const ParamType& eType1, const bool& bExtShape1, CXmlWriter& oWriter)
	{
		GUIDE_PARAM_1(sqrt)
	}
	...
	void CFormulaConverter::ConvertProd(const std::wstring& strParam1, const std::wstring& strParam2, const LONG& lParam3, CXmlWriter& oWriter)
	{
