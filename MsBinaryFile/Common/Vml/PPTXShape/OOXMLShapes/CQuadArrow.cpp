...
#include "CQuadArrow.h"

namespace OOXMLShapes
{
			CQuadArrow::CQuadArrow()
			{
				LoadFromXML(
					_T("<ooxml-shape>")
					_T("<avLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  _T("<gd name=\"adj1\" fmla=\"val 22500\" />")
					  _T("<gd name=\"adj2\" fmla=\"val 22500\" />")
					  _T("<gd name=\"adj3\" fmla=\"val 22500\" />")
					_T("</avLst>")
					_T("<gdLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("<gd name=\"y5\" fmla=\"+- vc dx2 0\" />")
					  _T("<gd name=\"y3\" fmla=\"+- vc 0 dx3\" />")
					  _T("<gd name=\"y4\" fmla=\"+- vc dx3 0\" />")
					  _T("<gd name=\"y6\" fmla=\"+- b 0 x1\" />")
					...
					_T("<cxnLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("</cxn>")
					_T("</cxnLst>")
					_T("<rect l=\"il\" t=\"y3\" r=\"ir\" b=\"y4\" xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\" />")
