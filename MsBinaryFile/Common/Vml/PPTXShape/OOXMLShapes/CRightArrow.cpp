...
#include "CRightArrow.h"

namespace OOXMLShapes
{
			CRightArrow::CRightArrow()
			{
				LoadFromXML(
					_T("<ooxml-shape>")
					...
					_T("<gdLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("<gd name=\"dx2\" fmla=\"*/ y1 dx1 hd2\" />")
					  _T("<gd name=\"x2\" fmla=\"+- x1 dx2 0\" />")
					_T("</gdLst>")
					...
					_T("<cxnLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("</cxn>")
					_T("</cxnLst>")
					_T("<rect l=\"l\" t=\"y1\" r=\"x2\" b=\"y2\" xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\" />")
