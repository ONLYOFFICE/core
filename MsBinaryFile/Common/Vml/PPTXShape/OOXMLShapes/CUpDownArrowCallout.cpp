...
#include "CUpDownArrowCallout.h"

namespace OOXMLShapes
{
			CUpDownArrowCallout::CUpDownArrowCallout()
			{
				LoadFromXML(
					_T("<ooxml-shape>")
					...
					_T("<gdLst xmlns=\"http://schemas.openxmlformats.org/drawingml/2006/main\">")
					  ...
					  _T("<gd name=\"maxAdj3\" fmla=\"*/ 50000 h ss\" />")
					  _T("<gd name=\"a3\" fmla=\"pin 0 adj3 maxAdj3\" />")
					  _T("<gd name=\"q2\" fmla=\"*/ a3 ss hd2\" />")
					  ...
					  _T("<gd name=\"dy2\" fmla=\"*/ h a4 200000\" />")
