...
std::wstring CImageElement::ConvertPPTtoPPTX(const CFormParam &pCoef, bool bIsNamespace)
{
    if (bIsNamespace)
    {
...
std::wstring CShapeElement::ConvertPPTtoPPTX(CPPTShape* pPPTShape, const NSGuidesVML::CFormParam& pCoef, bool bIsNamespace = false)
{
...
#else
std::wstring CShapeElement::ConvertPPTtoPPTX(CPPTShape *pPPTShape, const CFormParam &pCoef, bool bIsNamespace)
{
...
CShapeElement::CShapeElement(ClassType ClassType, int eType) : CElement()
{
    m_lShapeType			= eType;
...
CShapeElement::CShapeElement() : CElement()
{
    m_lShapeType	= 0x1000;
    m_etType		= etShape;
    m_bShapePreset	= false;
...
OOXMLShapes::ShapeType PPTX2EditorAdvanced::GetShapeTypeFromStr(const std::wstring &str)//const
{
    if(str == _T(""))
