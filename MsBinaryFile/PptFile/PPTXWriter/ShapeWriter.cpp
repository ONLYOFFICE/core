...
void CShapeWriter::SetRelsGenerator(CRelsGenerator *pGenerator)
{
    m_pRels = pGenerator;
}

void CShapeWriter::CalculateFullTransform()
{
...
void CShapeWriter::MoveTo(const double &dX, const double &dY)
{
    double x = dX;
    double y = dY;
...
void CShapeWriter::LineTo(const double &dX, const double &dY)
{
    double x = dX;
    double y = dY;
    m_oFullTransform.TransformPoint(x, y);
...
void CShapeWriter::CurveTo(const double &x1, const double &y1, const double &x2, const double &y2, const double &x3, const double &y3)
{
    double _x1 = x1;
    double _y1 = y1;
...
void CShapeWriter::Start()
{
    m_oWriterPath.ClearNoAttack();
}

void CShapeWriter::End()
{
    m_oWriterPath.ClearNoAttack();
}

void CShapeWriter::Close()
{
