...
CSlide::CSlide() : CElementsContainer(),
...
void CSlide::SetUpTextStyle(IElement *pElem)
{
...
void CSlide::SetUpTextTypeStyle(CTextAttributesEx *pTextAttributes, NSOfficePPT::TextType eApplyType, LONG lApplyMode)
{
...
void CSlide::SetUpAllTextType(CTextAttributesEx *pTextAttributes, NSOfficePPT::TextType eTypeMaster, NSOfficePPT::TextType eTypePersist, BOOL bPersistPresent, NSOfficePPT::TextType eTypeOwn, BOOL bOwnPresent)
{
    if (bOwnPresent)
    {
...
void CSlide::ApplyHyperlink(CShapeElement *pShape, SColorAtom &oColor)
{
...
void CSlide::InsertCF(LONG lStartH, LONG lEndH, CAtlArray<STextCFRun> &oArrayCF, CAtlArray<LONG> &arStart, CAtlArray<LONG> &arEnd, LONG lIndexFound, SColorAtom &oColor)
{
