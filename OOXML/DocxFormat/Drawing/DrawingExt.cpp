...
namespace OOX
{
	namespace Drawing
	{
        ...
        std::wstring COfficeArtExtension::toXMLWithNS(const std::wstring& sNamespace) const
		{
			...
			if (m_oChartDLbl.IsInit())
			{
				NSStringUtils::CStringBuilder writer;
				m_oChartDLbl->toXMLEntry(L"c15", writer);
				sResult += writer.GetData().c_str();
			}
            ...
            if (obj->get_type() == XLS::typeFRTWORKBOOK)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_TABLESLICERCACHEIDS != nullptr)
                    {
                        ...
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{46BE6895-7355-4a93-B00E-2C351335B9C9}");
                    ...
                    if (ptr->m_SLICERCACHEIDS != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{BBE1A952-AA13-448e-AADC-164F8A28A991}");
            ...
            else if (obj->get_type() == XLS::typeFRTWORKSHEET)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_CONDITIONALFORMATTINGS != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{78C0D931-6437-407d-A8EE-F0AAD7539E65}");
                    ...
                    if (ptr->m_DVALS14 != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{CCE6A557-97BC-4B89-ADB6-D9C93CAAB3DF}");
                    ...
                    if (ptr->m_SPARKLINEGROUPS != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{05C60535-1F16-4fd2-B633-F4F36F0B64E0}");
                    ...
                    if (ptr->m_TABLESLICERSEX != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{A8765BA9-456A-4dab-B4F3-ACF838C121DE}");
            ...
            else if (obj->get_type() == XLS::typeFRTSTYLESHEET)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_STYLESHEET14 != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{EB79DEF2-80B8-43E5-95BD-54CBDDF9020C}");
                    ...
                    if (ptr->m_DXF14S != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{46F421CA-312F-682F-3DD2-61675219B42D}");
            ...
            else if (obj->get_type() == XLS::typeFRTTABLE)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_BrtList14 != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{504A1905-F514-4f6f-8877-14C23A59335A}");
            ...
            else if (obj->get_type() == XLS::typeFRTEXTCONNECTIONS)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_EXTCONN15 != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{DE250136-89BD-433C-8126-D09CA5730AF9}");
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_SLICERCACHEBOOKPIVOTTABLES != nullptr)
                    {
                        ...
                        if (ptr1->m_BrtSlicerCacheBookPivotTables != nullptr)
                        {
                            OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                            oExt->m_sUri.Init();
                            oExt->m_sUri->append(L"{03082B11-2C62-411c-B77F-237D8FCFBE4C}");
                    ...
                    if (ptr->m_TABLESLICERCACHE != nullptr)
                    {
                        ...
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{2F2917AC-EB37-4324-AD4E-5DD8C200BD13}");
                    ...
                    if (ptr->m_SLICERCACHECROSSFILTEREXT != nullptr)
                    {
                        ...
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{470722E0-AACD-4C17-9CDC-17EF765DBC7E}");
            ...
            else if (obj->get_type() == XLS::typeFRTPIVOTCACHEDEF)
            {
                ...
                if (ptr != nullptr)
                {
                    if (ptr->m_PCD14 != nullptr)
                    {
                        OOX::Drawing::COfficeArtExtension *oExt = new OOX::Drawing::COfficeArtExtension();
                        oExt->m_sUri.Init();
                        oExt->m_sUri->append(L"{725AE2AE-9491-48be-B2B4-4EB974FC3084}");
