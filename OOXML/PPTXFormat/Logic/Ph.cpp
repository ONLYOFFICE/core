...
namespace PPTX
{
	namespace Logic
	{
		...
		void Ph::fromXML(XmlUtils::CXmlLiteReader& oReader)
		{
			ReadAttributes(oReader);
		}
		void Ph::ReadAttributes(XmlUtils::CXmlLiteReader& oReader)
		{
		...
		void Ph::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		void Ph::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
		...
		void Ph::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void Ph::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
		...
		void Ph::FillParentPointersForChilds()
		{
		}
	} // namespace Logic
} // namespace PPTX
