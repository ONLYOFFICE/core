...
namespace PPTX
{
	namespace Logic
	{
		void AnimRot::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		std::wstring AnimRot::toXML() const
		{
		...
		OOX::EElementType AnimRot::getType() const
		{
			return OOX::et_p_animRot;
		}
		void AnimRot::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
			pWriter->WriteString(toXML());
		}
		void AnimRot::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void AnimRot::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
