...
namespace PPTX
{
	namespace Logic
	{
		void BldDgm::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		std::wstring BldDgm::toXML() const
		{
		...
		void BldDgm::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
			pWriter->WriteString(toXML());
		}
		OOX::EElementType BldDgm::getType() const
		{
			return OOX::et_p_bldDgm;
		}
		void BldDgm::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void BldDgm::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
