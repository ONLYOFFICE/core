...
namespace PPTX
{
	namespace Logic
	{
		void Cmd::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		OOX::EElementType Cmd::getType() const
		{
			return OOX::et_p_cmd;
		}
		void Cmd::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
			pWriter->WriteString(toXML());
		}
		void Cmd::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void Cmd::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
