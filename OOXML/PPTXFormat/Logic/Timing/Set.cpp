...
namespace PPTX
{
	namespace Logic
	{
		void Set::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		OOX::EElementType Set::getType() const
		{
			return OOX::et_p_set;
		}
		void Set::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
			pWriter->WriteString(toXML());
		}
		void Set::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
		...
		void Set::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
