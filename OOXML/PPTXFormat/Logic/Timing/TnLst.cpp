...
namespace PPTX
{
	namespace Logic
	{
		TnLst& TnLst::operator=(const TnLst& oSrc)
		{
		...
		void TnLst::fromXML(XmlUtils::CXmlNode& node)
		{
		...
		void TnLst::toXmlWriter(NSBinPptxRW::CXmlWriter* pWriter) const
		{
		...
		void TnLst::toPPTY(NSBinPptxRW::CBinaryFileWriter* pWriter) const
		{
		...
		void TnLst::fromPPTY(NSBinPptxRW::CBinaryFileReader* pReader)
		{
