...
namespace XLSB
{
    // Logical representation of BrtBeginPCD14 record in BIFF12
    class BeginPCD14: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(BeginPCD14)
            BASE_OBJECT_DEFINE_CLASS_NAME(BeginPCD14)
        public:
            BeginPCD14();
            ~BeginPCD14();
