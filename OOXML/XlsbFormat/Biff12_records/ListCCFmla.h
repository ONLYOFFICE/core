...
namespace XLSB
{
    // Logical representation of BrtListCCFmla record in BIFF12
    class ListCCFmla: public XLS::BiffRecord
    {
            BIFF_RECORD_DEFINE_TYPE_INFO(ListCCFmla)
            BASE_OBJECT_DEFINE_CLASS_NAME(ListCCFmla)
        public:
            ListCCFmla();
            ~ListCCFmla();
