...
#include "../Biff12_unions/PIVOTFILTERCOLUMN.h"
...
namespace XLSB
{
    ...
    BaseObjectPtr AFILTER::clone()
    {
        return BaseObjectPtr(new AFILTER(*this));
    }

    //AFILTER = BrtBeginAFilter 1*PIVOTFILTERCOLUMN BrtEndAFilter
    const bool AFILTER::loadContent(BinProcessor& proc)
    {
