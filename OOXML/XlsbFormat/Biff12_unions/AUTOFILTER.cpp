...
#include "../Biff12_records/BeginAFilter.h"
#include "../Biff12_unions/FILTERCOLUMN.h"
#include "../Biff12_unions/SORTSTATE.h"
#include "../Biff12_unions/FRT.h"
#include "../Biff12_records/EndAFilter.h"
...
namespace XLSB
{
    ...
    const bool AUTOFILTER::loadContent(BinProcessor& proc)
    {
        ...
        if (proc.optional<BeginAFilter>())
        {
            m_BrtBeginAFilter = elements_.back();
            elements_.pop_back();
        }        

        int countFILTERCOLUMN = proc.repeated<FILTERCOLUMN>(0, 0);

        while(countFILTERCOLUMN > 0)
        {
            m_arFILTERCOLUMN.insert(m_arFILTERCOLUMN.begin(), elements_.back());
            elements_.pop_back();
            countFILTERCOLUMN--;
        }
        ...
        return m_BrtBeginAFilter && m_BrtEndAFilter;
    }
