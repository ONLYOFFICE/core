...
TEST(SMConvectorTest, BinOperatorPlus)
{
	...
	EXPECT_EQ(oConverterStarMath.ConvertStarMathToOOXml(wsBinOperator),XmlString);
}
...
TEST(SMConvectorTest,OperatorSum)
{
	...
	EXPECT_EQ(oConverterStarMath.ConvertStarMathToOOXml(wsOperator),XmlString);
}
