...
#define BuiltinFontsCount       14
#define BuiltinFontSubsetsCount 12

namespace PdfReader
{
	static BuiltinFontWidth c_arrCourierWidthsTable[] = 
	{
		{ "Ntilde",                            600, NULL },
		{ "rcaron",                            600, NULL },
	...
	static BuiltinFontWidth c_arrCourierBoldWidthsTable[] = 
	{
		{ "Ntilde",                            600, NULL },
		{ "rcaron",                            600, NULL },
		{ "kcommaaccent",                      600, NULL },
	...
	static BuiltinFontWidth c_arrCourierBoldObliqueWidthsTable[] = 
	{
		{ "Ntilde",                            600, NULL },
		{ "rcaron",                            600, NULL },
		{ "kcommaaccent",                      600, NULL },
	...
	static BuiltinFontWidth c_arrCourierObliqueWidthsTable[] = 
	{
		{ "Ntilde",                            600, NULL },
		{ "rcaron",                            600, NULL },
		{ "kcommaaccent",                      600, NULL },
	...
	static BuiltinFontWidth c_arrHelveticaWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            333, NULL },
	...
	static BuiltinFontWidth c_arrHelveticaBoldWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            389, NULL },
	...
	static BuiltinFontWidth c_arrHelveticaBoldObliqueWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            389, NULL },
		{ "kcommaaccent",                      556, NULL },
	...
	static BuiltinFontWidth c_arrHelveticaObliqueWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            333, NULL },
		{ "kcommaaccent",                      500, NULL },
	...
	static BuiltinFontWidth c_arrSymbolWidthsTable[] = 
	{
	...
	static BuiltinFontWidth c_arrTimesBoldWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            444, NULL },
		{ "kcommaaccent",                      556, NULL },
	...
	static BuiltinFontWidth c_arrTimesBoldItalicWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            389, NULL },
		{ "kcommaaccent",                      500, NULL },
	...
	static BuiltinFontWidth c_arrTimesItalicWidthsTable[] = 
	{
		{ "Ntilde",                            667, NULL },
		{ "rcaron",                            389, NULL },
	...
	static BuiltinFontWidth c_arrTimesRomanWidthsTable[] = 
	{
		{ "Ntilde",                            722, NULL },
		{ "rcaron",                            333, NULL },
		{ "kcommaaccent",                      500, NULL },
	...
	static BuiltinFontWidth c_arrZapfDingbatsWidthsTable[] = 
	{
		{ "a81",                               438, NULL },
		{ "a82",                               138, NULL },
		{ "a83",                               277, NULL },
	...
	static BuiltinFont c_arrBuiltinFonts[] = 
	{
		{ "Courier",               c_arrStandardEncoding,            629, -157, { -23, -250,  715,  805}, c_arrCourierWidthsTable,              315 },
		{ "Courier-Bold",          c_arrStandardEncoding,            629, -157, {-113, -250,  749,  801}, c_arrCourierBoldWidthsTable,          315 },
		{ "Courier-BoldOblique",   c_arrStandardEncoding,            629, -157, { -57, -250,  869,  801}, c_arrCourierBoldObliqueWidthsTable,   315 },
		{ "Courier-Oblique",       c_arrStandardEncoding,            629, -157, { -27, -250,  849,  805}, c_arrCourierObliqueWidthsTable,       315 },
		{ "Helvetica",             c_arrStandardEncoding,            718, -207, {-166, -225, 1000,  931}, c_arrHelveticaWidthsTable,            315 },
		{ "Helvetica-Bold",        c_arrStandardEncoding,            718, -207, {-170, -228, 1003,  962}, c_arrHelveticaBoldWidthsTable,        316 },
		{ "Helvetica-BoldOblique", c_arrStandardEncoding,            718, -207, {-174, -228, 1114,  962}, c_arrHelveticaBoldObliqueWidthsTable, 315 },
		{ "Helvetica-Oblique",     c_arrStandardEncoding,            718, -207, {-170, -225, 1116,  931}, c_arrHelveticaObliqueWidthsTable,     315 },
		{ "Symbol",                c_arrSymbolEncoding,             1010, -293, {-180, -293, 1090, 1010}, c_arrSymbolWidthsTable,               190 },
		{ "Times-Bold",            c_arrStandardEncoding,            683, -217, {-168, -218, 1000,  935}, c_arrTimesBoldWidthsTable,            315 },
		{ "Times-BoldItalic",      c_arrStandardEncoding,            683, -217, {-200, -218,  996,  921}, c_arrTimesBoldItalicWidthsTable,      315 },
		{ "Times-Italic",          c_arrStandardEncoding,            683, -217, {-169, -217, 1010,  883}, c_arrTimesItalicWidthsTable,          315 },
		{ "Times-Roman",           c_arrStandardEncoding,            683, -217, {-168, -218, 1000,  898}, c_arrTimesRomanWidthsTable,           315 },
		{ "ZapfDingbats",          c_arrZapfDingbatsEncoding,        820, -143, {  -1, -143,  981,  820}, c_arrZapfDingbatsWidthsTable,         202 }
	};

	static BuiltinFont *c_arrBuiltinFontSubset[] = 
	{
		&c_arrBuiltinFonts[0],
		&c_arrBuiltinFonts[3],
		&c_arrBuiltinFonts[1],
		...
		&c_arrBuiltinFonts[5],
		&c_arrBuiltinFonts[6],
		&c_arrBuiltinFonts[12],
		&c_arrBuiltinFonts[11],
		&c_arrBuiltinFonts[9],
		&c_arrBuiltinFonts[10]
	};
}

#endif // _PDF_READER_BUILTIN_FONT_TABLES_H
