 ...
 *
 */
#ifndef _PDF_READER_UNICODE_MAP_TABLES_H
#define _PDF_READER_UNICODE_MAP_TABLES_H

namespace PdfReader
{
	static UnicodeMapRange c_arrLatin1UnicodeMapRanges[] =
	{
...
#define Latin1UnicodeMapLen (sizeof(c_arrLatin1UnicodeMapRanges) / sizeof(UnicodeMapRange))

	static UnicodeMapRange c_arrASCII7UnicodeMapRanges[] =
	{
		{ 0x000a, 0x000a, 0x0a, 1 },
		{ 0x000c, 0x000d, 0x0c, 1 },
...
#define ASCII7UnicodeMapLen (sizeof(c_arrASCII7UnicodeMapRanges) / sizeof(UnicodeMapRange))

	static UnicodeMapRange c_arrSymbolUnicodeMapRanges[] =
	{
...
#define SymbolUnicodeMapLen (sizeof(c_arrSymbolUnicodeMapRanges) / sizeof(UnicodeMapRange))

	static UnicodeMapRange c_arrZapfDingbatsUnicodeMapRanges[] =
	{
...
#define ZapfDingbatsUnicodeMapLen (sizeof(c_arrZapfDingbatsUnicodeMapRanges) / sizeof(UnicodeMapRange))
}

#endif // _PDF_READER_UNICODE_MAP_TABLES_H