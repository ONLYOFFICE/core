...
#define RENDER_TO_OOX_PARAM_PIC_BULLET		    22
#define RENDER_TO_OOX_PARAM_SHAPE_CHILD		    23
...
#define RENDER_TO_OOX_PARAM_SHAPE     			29
#define RENDER_TO_OOX_PARAM_FIELD     			30
