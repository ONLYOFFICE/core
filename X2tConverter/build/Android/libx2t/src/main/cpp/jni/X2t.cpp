    ...
    JNI_FUNC(jobject, getOfficeFileFormats)(JNIEnv* env, jclass type) {
        TRY_JNI(env, {
            ...
            if (jjniHashMap.init(env)) {
                ...
                jjniHashMap.put(env, "AVS_OFFICESTUDIO_FILE_PRESENTATION_KEY", AVS_OFFICESTUDIO_FILE_PRESENTATION_KEY);
                jjniHashMap.put(env, "AVS_OFFICESTUDIO_FILE_PRESENTATION_ODG", AVS_OFFICESTUDIO_FILE_PRESENTATION_ODG);
                ...
                jjniHashMap.put(env, "AVS_OFFICESTUDIO_FILE_SPREADSHEET_NUMBERS", AVS_OFFICESTUDIO_FILE_SPREADSHEET_NUMBERS);
                ...
                jjniHashMap.put(env, "AVS_OFFICESTUDIO_FILE_OTHER_OOXML", AVS_OFFICESTUDIO_FILE_OTHER_OOXML);
