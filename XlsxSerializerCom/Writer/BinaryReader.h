...
namespace BinXlsxRW {
	...
	public:
		...
		int ReadAx(BYTE type, long length, void* poResult)
		{
			...
			//else if(c_oSer_ChartCatAxType::FormatCode == type)
			//{
			//	pCatAx->m_oNumFmt.Init();
			//	pCatAx->m_oNumFmt->m_oFormatCode.Init();
			//	pCatAx->m_oNumFmt->m_oFormatCode->Append(m_oBufferedStream.ReadString2(length));
			//	pCatAx->m_oNumFmt->m_oSourceLinked.Init();
			//	pCatAx->m_oNumFmt->m_oSourceLinked->FromBool(false);
			//}
